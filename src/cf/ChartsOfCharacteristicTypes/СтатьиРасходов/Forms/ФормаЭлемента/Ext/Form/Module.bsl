...
Процедура ЗаполнитьСписокВыбораКорСчета()
	...
	Если Объект.ВидДеятельностиРасходов = Перечисления.ВидыДеятельностиРасходов.ОсновнаяДеятельность Тогда
		СписокВыбора.Добавить("7110", НСтр("ru='Расходы по реализации продукции и оказанию услуг (7110)'"));
		СписокВыбора.Добавить("7210", НСтр("ru='Административные расходы (7210)'"));
		СписокВыбора.Добавить("8110", НСтр("ru='Основное производство (8110)'"));
		СписокВыбора.Добавить("8120", НСтр("ru='Производство из давальческого сырья (8120)'"));
		СписокВыбора.Добавить("8210", НСтр("ru='Полуфабрикаты собственного производства (8210)'"));
		СписокВыбора.Добавить("8310", НСтр("ru='Вспомогательные производства (8310)'"));
		СписокВыбора.Добавить("8410", НСтр("ru='Накладные расходы (8410)'"));
	КонецЕсли;
	Если Объект.ВидДеятельностиРасходов = Перечисления.ВидыДеятельностиРасходов.ПрочаяДеятельность Тогда
		СписокВыбора.Добавить("7470", НСтр("ru='Прочие расходы (7470)'"));
	КонецЕсли;
