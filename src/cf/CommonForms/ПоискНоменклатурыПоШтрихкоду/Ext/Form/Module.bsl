...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЕстьПодсистемаРаботаСНоменклатурой Тогда
		МодульРаботаСНоменклатурой().ВедетсяУчетПоХарактеристикам(ИспользоватьХарактеристикиНоменклатуры);
	КонецЕсли;
...
Функция МодульРаботаСНоменклатурой()
	...
	Возврат ОбщегоНазначения.ОбщийМодуль("РаботаСНоменклатуройУТ");
...
Функция МодульРаботаСНоменклатуройКлиент()
	...
	Возврат ОбщегоНазначенияКлиент.ОбщийМодуль("РаботаСНоменклатуройКлиентУТ");
...
Процедура НастроитьФормуПриСоздании()
	...
	РазрешеноПакетноеСозданиеНоменклатуры = Ложь;
	МодульРаботаСНоменклатурой().РазрешеноПакетноеСозданиеНоменклатуры(РазрешеноПакетноеСозданиеНоменклатуры);
	...
	Элементы.СоздатьВсе.Видимость                               = ИспользуетсяСервис1СНоменклатура
		И РазрешеноПакетноеСозданиеНоменклатуры;
