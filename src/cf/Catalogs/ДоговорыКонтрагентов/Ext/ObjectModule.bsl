...
Процедура ПередЗаписью(Отказ)
	...
	//++Аян_К++ 040422 старт
	//Если НЕ Альфа_КТ.ПроверитьДоступ("ЗаписьДоговораКонтрагентов", ПараметрыСеанса.ТекущийПользователь, ТекущаяДата(), ТекущаяДата()) Тогда
	//	Сообщить("Договора контрагентов может создать только куратор, обратитесь к куратору или в Help Desk", СтатусСообщения.ОченьВажное);
	//	Отказ = Истина;
	//КонецЕсли;
	//++Аян_К++ 040422 финиш
