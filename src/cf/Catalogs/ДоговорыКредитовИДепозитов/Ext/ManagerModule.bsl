...
//    Договоры - СписокЗначений - договора кредитов, депозитов, займов. Если пустой, то оплаты по оплаты всем договорам
//                                за указаный период.
//    Контрагенты - СписокКонтрагентов - контрагенты кому предназначаются платежи. Если пустой, то оплаты всем
...
//
// Параметры:
//  ХарактерДоговора - Перечисление.ХарактерДоговораКредитовИДепозитов - характер договора кредита, депозита, займа по
