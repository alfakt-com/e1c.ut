...
Процедура ТипДоговораСрочностиПриИзмененииСервер()
	...
	ЗаполнитьСтатьиУчета(Объект.ХарактерДоговора, Объект.ТипДоговора, Объект.ТипСрочности, Ложь);
...
&НаСервере
Процедура ЗаполнитьСтатьиУчета(ДоговорХарактер, ДоговорТип, ТипСрочности, Очистить = Истина)
...
Процедура УстановитьВидимость()
	...
	ПартнерыИКонтрагенты.ЗаголовокЭлементаПартнерВЗависимостиОтХарактераДоговораКредитаИДепозита(ЭтотОбъект, "Партнер", Объект.ХарактерДоговора);
