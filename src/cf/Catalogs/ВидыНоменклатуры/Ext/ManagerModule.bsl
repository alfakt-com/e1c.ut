...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	|	Справочник.ВидыНоменклатуры КАК ВидыНоменклатуры
	|ГДЕ
	|	ВидыНоменклатуры.СтавкаНДС = ЗНАЧЕНИЕ(Справочник.СтавкиНДС.НДС0)";
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Попытка
			...
			Если СправочникОбъект.СтавкаНДС = Справочники.СтавкиНДС.НДС0 Тогда
				СправочникОбъект.СтавкаНДС = Справочники.СтавкиНДС.ПустаяСсылка();
				ОбъектИзменен = Истина;
			КонецЕсли;
			
			ВыборкаСкладов = Выборка.Выбрать();
			Пока ВыборкаСкладов.Следующий() Цикл
				Если Не ВыборкаСкладов.ЗаполнитьСтавкуНДС Тогда
