...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	РаботаСНоменклатурой.ПриСозданииНаСервереФормаВидаНоменклатуры(ЭтотОбъект, Элементы.ГруппаРаботаСНоменклатурой, "Гиперссылка");
...
Процедура НастроитьФорму()
	...
	ИспользоватьСтарыеКлассификаторы = ПолучитьФункциональнуюОпцию("ИспользованиеСтарыхКлассификаторовОКПиОКВЭД") ИЛИ НЕ ПолучитьФункциональнуюОпцию("ОтключенныйФункционал");
	...
	Элементы.КодОКП.Видимость = (ЭтоТовар
									...
									Или ЭтоНабор)
									И Не Объект.КиЗГИСМ
									И ИспользоватьКлассификаторыНоменклатуры И ПолучитьФункциональнуюОпцию("ОтключенныйФункционал");
