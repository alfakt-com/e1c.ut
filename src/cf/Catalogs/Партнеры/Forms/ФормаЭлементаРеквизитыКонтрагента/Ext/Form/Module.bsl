...
Процедура УправлениеДоступностью()
	...
	Если ЮрФизЛицо = Перечисления.ЮрФизЛицо.ЮрЛицоНеРезидент
		И СтранаРегистрации = Справочники.СтраныМира.Казахстан Тогда
...
Процедура ЗаписатьКонтрагентаПартнера()
	...
	КонтрагентОбъект.СтранаРегистрации         = ?(ЮрФизЛицо = Перечисления.ЮрФизЛицо.ЮрЛицоНеРезидент, СтранаРегистрации, Справочники.СтраныМира.Казахстан);
	...
	КонтрагентОбъект.ГосударственноеУчреждение = ?(ЮрФизЛицо = Перечисления.ЮрФизЛицо.ЮрЛицоНеРезидент, Ложь, ГосударственноеУчреждение);
