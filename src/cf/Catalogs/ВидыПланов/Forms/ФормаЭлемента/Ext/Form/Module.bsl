...
Процедура УстановитьВидимость(Форма)
	...
	Форма.Элементы.ЗаполнятьСклад.Видимость = ЭтоПланЗапкупок ИЛИ ЭтоПланОстатков ИЛИ ЭтоПланСборкиРазборки ИЛИ ВыборСклада И (ЭтоПланПродаж ИЛИ ЭтоПланПродажПоКатегориям);
	Форма.Элементы.ГруппаЗаполнятьСкладВТЧ.Видимость = НЕ Форма.Объект.ЗаполнятьПоФормуле И (ЭтоПланЗапкупок ИЛИ ЭтоПланОстатков ИЛИ ЭтоПланСборкиРазборки ИЛИ (ВыборСклада ИЛИ ВыборСкладаИлиФорматам) И (ЭтоПланПродаж  ИЛИ ЭтоПланПродажПоКатегориям));
