...
Процедура ПередЗаписью(Отказ)
	...
	//++Тишбаев О.М.
	//Временно для Кравцовой А.В. пока не забацаем роли.
	Если ЭтотОбъект.ПометкаУдаления 
		И ПараметрыСеанса.ТекущийПользователь <> Справочники.Пользователи.ПолучитьСсылку(Новый УникальныйИдентификатор("df146a74-07f9-11df-b3da-001cc012ac40")) Тогда
