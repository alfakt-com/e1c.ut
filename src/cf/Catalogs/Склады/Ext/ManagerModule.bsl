...
Процедура ОбработкаПолученияДанныхВыбора(ДанныеВыбора, Параметры, СтандартнаяОбработка)
	...
	//
	//ГруппаПользователей = Справочники.ГруппыПользователей.НайтиПоНаименованию("Отдел ""Закупа""", Истина);
	//ВходитВГруппуЗакупа = ГруппаПользователей.Состав.Найти(ПараметрыСеанса.ТекущийПользователь, "Пользователь") <> Неопределено;
	//
	//Если Параметры.Свойство("СкладОтправитель", ЗначениеПараметра) И ЗначениеПараметра И НЕ ВходитВГруппуЗакупа Тогда
	//	
	...
	//	
	//	Запрос.УстановитьПараметр("ТипСклада", Перечисления.ТипыСкладов.РозничныйМагазин);
	//	
	//	ДанныеВыбора.ЗагрузитьЗначения(Запрос.Выполнить().Выгрузить().ВыгрузитьКолонку("Склад"));
	//Иначе
