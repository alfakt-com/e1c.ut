...
Процедура ЗаполнитьУсловияПродаж(Знач УсловияПродаж) Экспорт
	...
	Если УсловияПродаж.ИспользуютсяДоговорыКонтрагентов <> Неопределено И УсловияПродаж.ИспользуютсяДоговорыКонтрагентов Тогда
        ...
        Если ТипДоговора = Перечисления.ТипыДоговоров.СПокупателем 
            И ЗначениеЗаполнено(ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Договор, "СпособВыпискиАктовВыполненныхРабот")) Тогда
				...
				Если ИспользоватьСоглашенияСКлиентами Тогда
					...
					ПродажиСервер.ЗаполнитьЦены(
						...
						Новый Структура( // Параметры заполнения
							"Дата, Валюта, Соглашение, РасчитыватьНаборы, НалогообложениеНДС, ПоляЗаполнения, КолонкиПоЗначению",
							Дата,
							Валюта,
							Соглашение,
							Истина,
...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
    ...
    Если ЗначениеЗаполнено(Договор) И ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Договор, "ТипДоговора") = Перечисления.ТипыДоговоров.СПокупателем
       И НЕ СпособВыпискиАктовВыполненныхРабот = (ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Договор, "СпособВыпискиАктовВыполненныхРабот")) Тогда
        СпособВыпискиАктовВыполненныхРабот = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Договор, "СпособВыпискиАктовВыполненныхРабот");
    КонецЕсли;
