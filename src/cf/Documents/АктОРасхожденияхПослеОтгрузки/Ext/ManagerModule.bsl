...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ru = 'Акт о расхождениях при приемке товаров'");
	КомандаПечати.ДополнительныеПараметры.Вставить("ПечатьВНоменклатуреПоставщика", Ложь);
	КомандаПечати.ПроверкаПроведенияПередПечатью = Истина;
...
Функция ПолучитьДанныеДляПечатнойФормыА1(ПараметрыПечати, МассивОбъектов) Экспорт
	...
	Запрос.Текст ="
	|ВЫБРАТЬ
	|	МИНИМУМ(АктОРасхожденияхПослеОтгрузкиПриемкаТоваров.ДатаНачалаПриемки) КАК ДатаНачалаПриемки,
	|	МАКСИМУМ(АктОРасхожденияхПослеОтгрузкиПриемкаТоваров.ДатаОкончанияПриемки) КАК ДатаОкончанияПриемки,
	|	АктОРасхожденияхПослеОтгрузкиПриемкаТоваров.Ссылка
	|ПОМЕСТИТЬ ДатыПриемки
	|ИЗ
	|	Документ.АктОРасхожденияхПослеОтгрузки.ПриемкаТоваров КАК АктОРасхожденияхПослеОтгрузкиПриемкаТоваров
	|ГДЕ
	|	АктОРасхожденияхПослеОтгрузкиПриемкаТоваров.Ссылка В(&МассивОбъектов)
	|
	|СГРУППИРОВАТЬ ПО
	|	АктОРасхожденияхПослеОтгрузкиПриемкаТоваров.Ссылка
	|;
	...
	|		ПО АктОРасхожденияхПослеОтгрузки.Ссылка = ДатыПриемки.Ссылка
	|ГДЕ
	|	АктОРасхожденияхПослеОтгрузки.Ссылка В(&МассивОбъектов)
	|
	|УПОРЯДОЧИТЬ ПО
	...
	|ВЫБРАТЬ
	|	АктОРасхожденияхПослеОтгрузкиТовары.Ссылка КАК Ссылка,
	|	АктОРасхожденияхПослеОтгрузкиТовары.Номенклатура КАК НаименованиеПродукции,
	|	АктОРасхожденияхПослеОтгрузкиТовары.Характеристика КАК Характеристика,
	|	ВЫБОР
	|		КОГДА АктОРасхожденияхПослеОтгрузкиТовары.Упаковка = ЗНАЧЕНИЕ(Справочник.УпаковкиЕдиницыИзмерения.ПустаяСсылка)
	|			ТОГДА АктОРасхожденияхПослеОтгрузкиТовары.Номенклатура.ЕдиницаИзмерения
	|		ИНАЧЕ АктОРасхожденияхПослеОтгрузкиТовары.Упаковка
	...
	|	АктОРасхожденияхПослеОтгрузкиТовары.Количество КАК КоличествоПоФакту,
	|	ВЫБОР
	|		КОГДА АктОРасхожденияхПослеОтгрузкиТовары.КоличествоПоДокументу <> 0
	|			ТОГДА АктОРасхожденияхПослеОтгрузкиТовары.СуммаПоДокументу / АктОРасхожденияхПослеОтгрузкиТовары.КоличествоПоДокументу
	|		ИНАЧЕ 0
	|	КОНЕЦ КАК ЦенаПоДокументам,
	|	АктОРасхожденияхПослеОтгрузкиТовары.Сумма КАК СуммаПоФакту,
	|	АктОРасхожденияхПослеОтгрузкиТовары.СуммаНДС СуммаНДСПоФакту,
	|	ВЫБОР
	|		КОГДА АктОРасхожденияхПослеОтгрузкиТовары.Количество <> 0
	|			ТОГДА АктОРасхожденияхПослеОтгрузкиТовары.Сумма / АктОРасхожденияхПослеОтгрузкиТовары.Количество
	|		ИНАЧЕ 0
	...
	|	АктОРасхожденияхПослеОтгрузкиТовары.НомерСтроки КАК НомерСтроки,
	|	АктОРасхожденияхПослеОтгрузкиТовары.НомерПаспорта
	|ИЗ
	|	Документ.АктОРасхожденияхПослеОтгрузки.Товары КАК АктОРасхожденияхПослеОтгрузкиТовары
	|ГДЕ
	|	АктОРасхожденияхПослеОтгрузкиТовары.Ссылка В(&МассивОбъектов)
