...
Процедура ПриЗаписи(Отказ)
	...
	ТребуетсяСчетФактураПолученный = РасчетыЧерезОтдельногоКонтрагента;
...
Процедура ЗаполнитьНалогобложениеИЦеныПоУмолчанию()
	...
	Действия = Новый Структура("ЗаполнитьСтавкуНДС", НалогообложениеНДС);
...
Процедура ЗаполнитьВидЦеныПоУмолчанию()
	Если Не ЗначениеЗаполнено(ВидЦены) Тогда
		ВидЦены = Справочники.ВидыЦен.ВидЦеныПоУмолчанию(
			ВидЦены,
...
Функция ПараметрыЗаполненияВидовЗапасов(ИмяПоляОрганизация, ЗаполнениеВидовЗапасов)                        
	...
	Если ИмяПоляОрганизация = "Организация" Тогда
		...
		Иначе
			...
			УчетНДСУТ.ПараметрыЗаполненияВидовЗапасовПоНалогообложению(ПараметрыЗаполнения.ОтборыВидовЗапасов, Организация, Дата, НалогообложениеНДС);
