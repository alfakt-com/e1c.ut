...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ДокументыПоступления.Параметры.УстановитьЗначениеПараметра("ОтборПоНалоговомуПериоду",	ЗначениеЗаполнено(Параметры.НалоговыйПериод));
	ДокументыПоступления.Параметры.УстановитьЗначениеПараметра("НалоговыйПериодНачало", 	НачалоМесяца(Параметры.НалоговыйПериод));
	ДокументыПоступления.Параметры.УстановитьЗначениеПараметра("НалоговыйПериодОкончание", 	КонецМесяца(Параметры.НалоговыйПериод));
