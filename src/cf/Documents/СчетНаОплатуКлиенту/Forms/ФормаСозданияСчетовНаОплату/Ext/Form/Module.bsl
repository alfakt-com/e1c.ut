...
Процедура ОбновитьСервер()
	...
	Иначе
		...
		ЕстьКодНазначенияПлатежа = ОбщегоНазначенияКлиентСервер.ЕстьРеквизитИлиСвойствоОбъекта(ДокументОснование, "КодНазначенияПлатежа");
		...
		Запрос = Новый Запрос("
			...
			|	" + ?(ЕстьКодНазначенияПлатежа, "ДанныеДокумента.КодНазначенияПлатежа      КАК КодНазначенияПлатежа,", "") + "
			|	ДанныеДокумента.Ссылка                    КАК Документ,
