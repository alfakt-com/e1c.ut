...
Процедура УстановитьУсловноеОформление()
	...
	МассивСтавокБезНДС = Новый Массив;
	МассивСтавокБезНДС.Добавить(Справочники.СтавкиНДС.БезНДС);
	МассивСтавокБезНДС.Добавить(Справочники.СтавкиНДС.БезНДСНеРК);
	
	ОтборЭлемента = ГруппаОтбора.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
	ОтборЭлемента.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("Объект.ПрочиеРасходы.СтавкаНДС");
	ОтборЭлемента.ВидСравнения = ВидСравненияКомпоновкиДанных.ВСписке;
	ОтборЭлемента.ПравоеЗначение = МассивСтавокБезНДС;
