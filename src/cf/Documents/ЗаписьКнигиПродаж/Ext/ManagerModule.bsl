...
Процедура ЗаполнитьРасхождения(Объект) Экспорт
	...
	|	ТаблицаЦенности.ВидОперацииРеализации КАК ВидОперацииРеализации,
	|	ТаблицаЦенности.ОборотПоРеализации КАК ОборотПоРеализации,
	...
	|	НовыеДанные.ВидОперацииРеализации КАК ВидОперацииРеализации,
	|	НовыеДанные.ОборотПоРеализации КАК ОборотПоРеализации,
	...
	|	ИсходныеДанные.ВидОперацииРеализации КАК ВидОперацииРеализации,
	|	-ИсходныеДанные.ОборотПоРеализации КАК ОборотПоРеализации,
	...
	|	НовыеДанныеИзТаблицы.ВидОперацииРеализации КАК ВидОперацииРеализации,
	|	НовыеДанныеИзТаблицы.ОборотПоРеализации КАК ОборотПоРеализации,
	...
	|	ДанныеДляРасхождения.ВидОперацииРеализации КАК ВидОперацииРеализации,
	|	СУММА(ДанныеДляРасхождения.ОборотПоРеализации) КАК ОборотПоРеализации,
	...
	|	ДанныеДляРасхождения.ВидОперацииРеализации,
