...
Процедура УправлениеДоступностьюЭлементовФормы(Форма)
	...
	Форма.Элементы.ТекстПоступлениеТоваров.Видимость        = ВидимостьТекстПоступлениеТоваров;
	Форма.Элементы.СтатусЕГАИСПредставление.Доступность     = ЕстьПравоИзменение;
