...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	КПП = ?(ПолучитьФункциональнуюОпцию("ОтключенныйФункционал"), Объект.КПППлательщика, Объект.РегистрацияВНалоговомОргане);
...
Процедура ЗаполнитьКПП()
	...
	Для каждого КППОрганизации Из СписокКППОрганизации Цикл
		...
		СписокВыбораКПП.Добавить(КППОрганизации.Ссылка, ?(ПолучитьФункциональнуюОпцию("ОтключенныйФункционал"), Представление, КППОрганизации.Ссылка.Наименование));
		СписокКПП.Добавить(КППОрганизации.Ссылка, ?(ПолучитьФункциональнуюОпцию("ОтключенныйФункционал"), КППОрганизации.КПП, КППОрганизации.Ссылка.Наименование));
	КонецЦикла;
