				...
				Если ИспользоватьСоглашенияСКлиентами И ПересчитатьЦены Тогда
					...
					ПродажиСервер.ЗаполнитьЦены(
						...
						Новый Структура( // Параметры заполнения
							"Дата, Валюта, Соглашение, НалогообложениеНДС, ВозвращатьМногооборотнуюТару, ПоляЗаполнения",
							Дата,
							Валюта,
							Соглашение,
							НалогообложениеНДС,
					...
					ПродажиСервер.ЗаполнитьЦены(
						...
						, // Массив строк или структура отбора
						Новый Структура( // Параметры заполнения
							"Дата, Валюта, Соглашение, НалогообложениеНДС, ВозвращатьМногооборотнуюТару, РасчитыватьНаборы, ПоляЗаполнения",
							Дата,
							Валюта,
							Соглашение,
							НалогообложениеНДС,
...
Процедура ПриЗаписи(Отказ)
	...
	ШаблонНазначения = Документы.ЗаявкаНаВозвратТоваровОтКлиента.ШаблонНазначения(ЭтотОбъект);
	Справочники.Назначения.ПриЗаписиДокумента(Назначение, ШаблонНазначения, ЭтотОбъект, Партнер, НалогообложениеНДС);
