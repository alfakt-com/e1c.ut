...
Процедура ПриОткрытии(Отказ)
	...
	//ТТ
	ЭтаФорма.Элементы.Номер.ТолькоПросмотр = Истина;
...
Процедура ТоварыПриОкончанииРедактирования(Элемент, НоваяСтрока, ОтменаРедактирования)
	...
	//Начало: Баубериков А - 22.05.2020
	ЦенаВключаетНДСПриИзмененииСервер(КэшированныеЗначения);
	//Конец: Баубериков А - 22.05.2020
КонецПроцедуры
...
Процедура ЗагрузитьИзВнешнегоФайла(Команда)
	...
	ПараметрыФормы.Вставить("Товары", Объект.Товары); //++Аян_К++ 061022 №6174
...
Процедура ПолучитьЗагруженныеТоварыИзХранилища(АдресТоваровВХранилище)
	...
	Для Каждого СтрокаТоваров Из ТоварыИзХранилища Цикл
		...
		СтрокаТЧТовары.ВидЦеныПоставщика = ПолучитьВидЦеныПоставщика(Объект.Партнер, СтрокаТоваров.ВидЦены);//++Аян_К++ 121022 №6174
		Если Объект.ПоступлениеОднойДатой Тогда
...
Функция ПолучитьВидЦеныПоставщика(Партнер, ВидЦены) //++Аян_К++ 121022 №6174 старт
...
КонецФункции //++Аян_К++ 121022 №6174 финиш
