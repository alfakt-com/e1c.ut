...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//++Аян_К++ надо переделать, срочно делаю по требованию ЕЮ
	БанковскийСчет = Справочники.БанковскиеСчетаОрганизаций.НайтиПоНаименованию("KZ48601A871002289351 KZT Народный Банк");
