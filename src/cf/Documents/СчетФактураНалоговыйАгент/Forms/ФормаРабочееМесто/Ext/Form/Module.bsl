...
Функция СоздатьСчетФактуруНалоговыйАгент(Знач ДанныеСчетФактуры) 
	...
	ДокументОснование = СчетФактураОбъект.ДокументОснование;
	Если ЗначениеЗаполнено(СчетФактураОбъект.ДокументОснование) И (ТипЗнч(ДокументОснование) = Тип("ДокументСсылка.ПриобретениеТоваровУслуг")
		ИЛИ ТипЗнч(ДокументОснование) = Тип("ДокументСсылка.ПриобретениеУслугПрочихАктивов")) Тогда
		СчетФактураОбъект.ВидОперацииПоступления = ДокументОснование.ВидПоступленияНДСНалоговогоАгента;
	КонецЕсли;
...
Процедура УстановитьЗначенияПоУмолчанию()
	...
	СтавкаНДС = Справочники.СтавкиНДС.НДС12;
...
Процедура УстановитьСтавкуНДС(ТекстСтавкаНДС)
	...
	ТекСтавкаНДС = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.СтавкиНДС.НДС12");
