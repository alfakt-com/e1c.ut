...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СНТСерверПереопределяемый.СоздатьЭлементыФормыСпискаДляВводаСНТ(ЭтаФорма, "СписокВозвратыТоваровОтКлиентовКоманднаяПанель");
...
Процедура ОбработкаКомандыСозданияСНТ(Команда)
	...
	СНТКлиент.СоздатьСНТ(Элементы.СписокВозвратыТоваровОтКлиентов.ВыделенныеСтроки); 
