...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	Если Не ЗначениеЗаполнено(НалогообложениеНДС) Тогда
		НалогообложениеНДС = ЗначениеНастроекПовтИсп.НалогообложениеНДС(Организация, Неопределено, Договор, НаправлениеДеятельности, Дата);
	КонецЕсли;
				...
				Если ИспользоватьСоглашенияСКлиентами Тогда
					...
					ПродажиСервер.ЗаполнитьЦены(
						...
						Новый Структура( // Параметры заполнения
							"Дата, Валюта, Соглашение, НалогообложениеНДС, ПоляЗаполнения",
