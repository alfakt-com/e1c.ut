...
Процедура ПриСозданииЧтенииНаСервере()
	...
	Элементы.ЗадолженностьКлиентовРасчетныйДокумент.Видимость = Не Объект.ВводОстатков22;
	...
	Элементы.ЗадолженностьПоставщикамРасчетныйДокумент.Видимость = Не Объект.ВводОстатков22;
	...
	Элементы.АвансыКлиентовРасчетныйДокумент.Видимость = Не Объект.ВводОстатков22;
	...
	Элементы.АвансыПоставщикамРасчетныйДокумент.Видимость = Не Объект.ВводОстатков22;
