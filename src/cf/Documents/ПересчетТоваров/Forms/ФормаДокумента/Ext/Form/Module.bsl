...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//++Аян_К++ 290722 заявка №5786 старт
	Если НЕ Альфа_КТ.ПроверитьДоступ("ДоступПересчетТоваров", ПользователиКлиентСервер.ТекущийПользователь(), ТекущаяДата(), ТекущаяДата()) Тогда
		Сообщить("Отказано в доступе!", СтатусСообщения.ОченьВажное);
		Отказ = Истина;  
	КонецЕсли;
	//++Аян_К++ 290722 заявка №5786 старт
...
Процедура ТоварыПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
	...
	Элементы.ТоварыКоличествоУпаковокФакт.Доступность = Истина;
	Элементы.ТоварыКоличествоУпаковокФакт.ТолькоПросмотр = Ложь;
	Элементы.ТоварыКоличествоУпаковокОтклонение.Доступность = Истина;
	Элементы.ТоварыКоличествоУпаковокОтклонение.ТолькоПросмотр = Ложь;
