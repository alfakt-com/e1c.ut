...
Процедура ИнициализироватьДокумент(ДанныеЗаполнения = Неопределено)
	...
	ЗаполнитьПотреблениеДляДеятельности();
...
Процедура ЗаполнитьПотреблениеДляДеятельности()
	
	ПотреблениеДляДеятельности = ЗначениеНастроекПовтИсп.ПередачаПодДеятельность(
									Организация,
