...
Процедура НалогообложениеНДСПриИзменении(Элемент)
	УстановитьВидимостьВидовПоступленияНДС();
КонецПроцедуры
...
&НаСервере
Процедура УстановитьВидимостьВидовПоступленияНДС()
	
	Элементы.ВидОперацииПоступления.Видимость = (Объект.НалогообложениеНДС = Перечисления.ТипыНалогообложенияНДС.ПродажаНеОблагаетсяНДС);
