...
Функция ПолучитьДанныеОбъектаПоМакетам(знач МассивДокументов, знач МассивИменМакетов) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		ДанныеОбъекта.Вставить("АдресОрганизацииКредитора",                 Выборка.АдресОрганизацииКредитора);
...
Функция ПолучитьДанныеВзаимозачетЗадолженности(МассивДокументов)
	...
	|	АдресОрганизацииКредитора.Представление КАК АдресОрганизацииКредитора
	|ИЗ
	|	Документ.ВзаимозачетЗадолженности КАК ДанныеДокумента
	|
	|	ЛЕВОЕ СОЕДИНЕНИЕ
	...
	|
	|	ЛЕВОЕ СОЕДИНЕНИЕ
	|		Справочник.Организации.КонтактнаяИнформация КАК АдресОрганизацииКредитора
	|	ПО
	|		ДанныеДокумента.ОрганизацияКредитор = АдресОрганизацииКредитора.Ссылка
	|		И (АдресОрганизацииКредитора.Вид = ЗНАЧЕНИЕ(Справочник.ВидыКонтактнойИнформации.ЮрАдресОрганизации))
	|
	|	ЛЕВОЕ СОЕДИНЕНИЕ
