...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИспользуютсяАктыОРасхожденияхПослеПриемки = ИСМПТВыбытиеКодовМаркировкиСервер.ИнтеграцияИСМП_АктыОРасхожденияПослеПоступленияИспользуются(Параметры.ПроверяемыйДокумент);
...
Процедура ОК(Команда)
	...
	Если Элементы.СтраницыВопросы.ТекущаяСтраница = Элементы.СтраницаКакУчитывать Тогда
		...
		Если КакУчитыватьНеПроверенныеОтложенные = 0 Тогда
			...
			ВозвращаемоеЗначение.КакУчитыватьНеПроверенныеОтложенные = ПредопределенноеЗначение("Перечисление.СтатусыПроверкиНаличияАлкогольнойПродукции.Отсутствует");
		...
		Иначе
			...
			ВозвращаемоеЗначение.КакУчитыватьНеПроверенныеОтложенные = ПредопределенноеЗначение("Перечисление.СтатусыПроверкиНаличияАлкогольнойПродукции.ВНаличии");
