...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ ЗначениеЗаполнено(Параметры.Организация) Тогда
		ВызватьИсключение НСтр("ru='Необходимо выбрать организацию.'");
		//ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru = 'Необходимо выбрать организацию.'"));
...
Процедура УстановитьТекстПодсказки(Форма)
	...
	ТекстСообщенияПодобрано = НСтр("ru='Всего подобрано к уплате [Подобрано] тг.'");
