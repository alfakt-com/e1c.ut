...
&НаКлиенте
Процедура ВыписыватьСчетаФактурыПоРезультатамРозничныхПродажПриИзменении(Элемент)
	УстановитьДоступность("НаборКонстант.ВыписыватьСчетаФактурыПоРезультатамРозничныхПродаж");
	Подключаемый_ПриИзмененииРеквизита(Элемент, Ложь);
КонецПроцедуры

&НаКлиенте
Процедура РазделятьТоварыПоИсточникамПроисхожденияПриИзменении(Элемент)
	Подключаемый_ПриИзмененииРеквизита(Элемент, Ложь);
КонецПроцедуры

&НаКлиенте
Процедура МаксимальноеКоличествоРазличныхВидовЗапасовВОтчетеОРозничныхПродажахПриИзменении(Элемент)
	Подключаемый_ПриИзмененииРеквизита(Элемент, Ложь);
КонецПроцедуры
...
&НаКлиенте
Процедура ВестиУчетТабачнойПродукцииМОТППриИзменении(Элемент)
	Подключаемый_ПриИзмененииРеквизита(Элемент);
	УстановитьЗначениеСвязанныхОпцийНаСервере();
КонецПроцедуры

&НаСервере
Процедура УстановитьЗначениеСвязанныхОпцийНаСервере()
