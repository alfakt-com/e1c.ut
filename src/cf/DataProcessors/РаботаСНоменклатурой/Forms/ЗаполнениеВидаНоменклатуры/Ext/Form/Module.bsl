...
Процедура ДобавитьНовыеРеквизитыВВидНоменклатуры(НовыеРеквизиты, ЯвляетсяРеквизитомХарактеристики, Отказ)
	...
	Если ЯвляетсяРеквизитомХарактеристики Тогда
		РеквизитНабораСвойств = "НаборСвойствХарактеристик";
	Иначе
		РеквизитНабораСвойств = "НаборСвойств";
	КонецЕсли;
	
	Если НЕ ЗначениеЗаполнено(ВидНоменклатуры[РеквизитНабораСвойств]) Тогда
		Отказ = Истина;
		Возврат;
	КонецЕсли;
	
	ЗаблокироватьДанныеДляРедактирования(ВидНоменклатуры[РеквизитНабораСвойств]);		
	НаборСвойств = ВидНоменклатуры[РеквизитНабораСвойств].ПолучитьОбъект();
	
	Для каждого ЭлементКоллекции Из РеквизитыКДобавлению Цикл
		НовыйРеквизит = НаборСвойств.ДополнительныеРеквизиты.Добавить();
		НовыйРеквизит.Свойство = ЭлементКоллекции;
	КонецЦикла;
