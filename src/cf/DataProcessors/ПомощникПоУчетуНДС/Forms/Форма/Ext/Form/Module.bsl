...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ГруппаРеестрПоНДС.Видимость					= ПолучитьФункциональнуюОпцию("ОтключенныйФункционал");
	...
	Элементы.ДекорацияБлокировкиВычетаНДС.Видимость 		= ПолучитьФункциональнуюОпцию("ОтключенныйФункционал");
	Элементы.ДекорацияОтчетыПоНДСВЭлектронномВиде.Видимость = ПолучитьФункциональнуюОпцию("ОтключенныйФункционал");
	Элементы.ДекорацияСверкаДанныхУчетаНДС.Видимость 		= ПолучитьФункциональнуюОпцию("ОтключенныйФункционал");
	...
	Элементы.ГруппаСчетФактураКомитента.Видимость          = ПолучитьФункциональнуюОпцию("ОтключенныйФункционал");
	Элементы.ГруппаСчетФактураКомиссионеру.Видимость       = ПолучитьФункциональнуюОпцию("ОтключенныйФункционал");
	...
	// если настройки формы не сохранены, то некорректно отрабатывает видимость не нужных элементов
	...
	Если ЗначениеЗаполнено(Объект.Организация) 
		...
		Пока Период < КонецМесяца(Объект.КонецПериода) Цикл
			...
			ИначеЕсли СостояниеРаспределениеНДС = Перечисления.СостоянияОперацийЗакрытияМесяца.ВыполненоУспешно Тогда
				...
				Элементы.ГруппаАнализРаспределенияНДС.Видимость = ПолучитьФункциональнуюОпцию("ОтключенныйФункционал");
...
Функция ОписаниеЗаголовковЭлементов()
	...
	ЗаголовкиЭлементов.Вставить("ЗаписиКнигиПродаж", 
			Новый Структура("НетДанных, ЕстьДанные",
					НСтр("ru = 'Нет ручных записей по НДС'"),
					НСтр("ru = 'Записи НДС (%1)'")));
					
	ЗаголовкиЭлементов.Вставить("ЗаписиКнигиПокупок", 
			Новый Структура("НетДанных, ЕстьДанные",
					НСтр("ru = 'Нет ручных записей по НДС к возмещению'"),
					НСтр("ru = 'Записи НДС к возмещению (%1)'")));
