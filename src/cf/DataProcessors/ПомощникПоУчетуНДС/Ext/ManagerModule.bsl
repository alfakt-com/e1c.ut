...
Функция СформироватьЗапросПоДокументамКОформлению(ПараметрыЗапроса, СтруктураВидимостиЭлементов = Неопределено, ТолькоОбязательныеОперации = Ложь) Экспорт
	...
	Если ТолькоОбязательныеОперации = Ложь Тогда
		...
		ТекстыЗапросов.Добавить(ТекстЗапросаСчетФактура(СтруктураВидимостиЭлементов, ПараметрыЗапроса, "ЗаписьКнигиПокупок", "И СчетФактура.ПредъявленСчетФактура"));
	...
	ТаблицаДокументовКОформлению = Запрос.Выполнить().Выгрузить();
	ТаблицаДокументовКОформлению.Свернуть("Документ", "КоличествоКОформлению, КоличествоОформленных");
	
	Возврат ТаблицаДокументовКОформлению;
...
Функция ТекстЗапросаСчетФактура(СтруктураВидимостиЭлементов, Параметры, ИмяИсточника, ТекстДопУсловия = Неопределено)
	...
	|	"+?(НЕ ТекстДопУсловия = Неопределено, ТекстДопУсловия, "")+"
	|
	|";
	
	Если НЕ ИмяИсточника = "ЗаписьКнигиПокупок" И СтруктураВидимостиЭлементов[ИмяИсточника]  Тогда
	...
	Если ИмяИсточника = "ЗаписьКнигиПокупок" Тогда
...
Функция ВидимостьЭлементов(Организация, Период) Экспорт
	...
	СтруктураВидимостиЭлементов.Вставить("СчетФактураВыданныйАванс",	ПолучитьФункциональнуюОпцию("ОтключенныйФункционал"));
	СтруктураВидимостиЭлементов.Вставить("СчетФактураПолученныйАванс",	ПолучитьФункциональнуюОпцию("ОтключенныйФункционал"));
	СтруктураВидимостиЭлементов.Вставить("СчетФактураНалоговыйАгент",	Истина);
	СтруктураВидимостиЭлементов.Вставить("СчетФактураКомитента",		ПолучитьФункциональнуюОпцию("ОтключенныйФункционал"));
	СтруктураВидимостиЭлементов.Вставить("СчетФактураКомиссионеру",		ПолучитьФункциональнуюОпцию("ОтключенныйФункционал"));
	...
	СтруктураВидимостиЭлементов.Вставить("ФормированиеЗаписейРаздела7",			ПолучитьФункциональнуюОпцию("ОтключенныйФункционал"));
	СтруктураВидимостиЭлементов.Вставить("РеестрДокументовПодтверждающихЛьготу",ПолучитьФункциональнуюОпцию("ОтключенныйФункционал"));
