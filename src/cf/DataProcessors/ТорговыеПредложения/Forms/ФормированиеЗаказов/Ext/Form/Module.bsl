...
Процедура ВыполнитьДлительнуюОперацию(Знач ТекущаяСтраница, СледующаяСтраница)
	...
	ИначеЕсли ТекущаяСтраница = Элементы.СтраницаОтправкиЗаказов
		...
		Элементы.НазваниеТекущейДлительнойОперации.Заголовок = НСтр("ru = 'Удаление документов'");
			
		Задание.Наименование = НСтр("ru = '1С:Бизнес-сеть. Торговые предложения. Удаление документов.'");
