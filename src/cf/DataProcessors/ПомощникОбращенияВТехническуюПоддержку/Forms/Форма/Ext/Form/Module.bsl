...
Процедура ОткрытьСайтИТС(Команда)
	...
	ОбщегоНазначенияУТКлиент.ЗапуститьПриложениеБезОбработкиРезультата("http://its.1c.kz/");
...
Процедура ОткрытьУправлениеРегламентными(Команда)
	...
	ОбщегоНазначенияУТКлиент.ЗапуститьПриложениеБезОбработкиРезультата("http://www.its.1c.kz/db/metod81#content:1622:1");
	ОбщегоНазначенияУТКлиент.ЗапуститьПриложениеБезОбработкиРезультата("http://www.its.1c.kz/db/metod81#content:1551:1");
...
Процедура ОткрытьТехнологическийЖурнал(Команда)
	...
	ОбщегоНазначенияУТКлиент.ЗапуститьПриложениеБезОбработкиРезультата("http://www.its.1c.kz/db/metod81#content:1501:1");
...
Процедура ОткрытьЗамерПроизводительности(Команда)
	...
	ОбщегоНазначенияУТКлиент.ЗапуститьПриложениеБезОбработкиРезультата("http://www.its.1c.kz/db/metod81#content:1553:1");
