...
Процедура ОбновитьСтраницуФормированияЗаданий()
	...
	|	ЗаданиеНаПеревозкуРаспоряжения.Распоряжение.Номер КАК РаспоряжениеНомер
	|ИЗ
	...
	Пока Выборка.СледующийПоЗначениюПоля("Ссылка") Цикл
		...
		//Начало: МК Баубериков А - 13.11.2020
		СтрокаЗадание.Распоряжение = Неопределено;
		СтрокаЗадание.РаспоряжениеНомер = ""; 
		//Конец: МК Баубериков А - 13.11.2020
		...
		Пока Выборка.СледующийПоЗначениюПоля("ПорядокВМаршруте")
			...
			Пока Выборка.Следующий() Цикл
				...
				//Начало: МК Баубериков А - 13.11.2020
				//Если не Выборка.Распоряжение = null тогда
					СтрокаРаспоряжение.Распоряжение = Выборка.Распоряжение;
					СтрокаРаспоряжение.РаспоряжениеНомер = Выборка.РаспоряжениеНомер;
				//Иначе
				//	СтрокаРаспоряжение.Распоряжение = Неопределено;
				//	СтрокаРаспоряжение.РаспоряжениеНомер = "";
				//КонецЕсли;
				//Конец: МК Баубериков А - 13.11.2020    
