...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Состояние <> Перечисления.СостоянияМиграцииПриложения.Выполняется Тогда
		...
		СостояниеРегистрациииВСервисе = Элементы.СостояниеРегистрациииВСервисе.СписокВыбора[0].Значение;
...
&НаКлиенте
Процедура СостояниеРегистрациииВСервисеПриИзменении(Элемент)
	
	Элементы.СтраницаИдентификационныеДанныеСтраницы.ТекущаяСтраница = 
		?(СостояниеРегистрациииВСервисе = "Зарегистрирован", 
...
Процедура ДекорацияРегистрацияНажатие(Элемент)
	...
	ПерейтиПоНавигационнойСсылке(АдресРегистрации);
...
Процедура ДекорацияВосстановлениеНажатие(Элемент)
	...
	ПерейтиПоНавигационнойСсылке(АдресВосстановления);
...
Процедура СтраницаИдентификационныеДанныеОткрытие(ЭтоПереходНазад)
	...
	Элементы.СостояниеРегистрациииВСервисе.Доступность = РегистрацияРазрешена;
...
Функция СтраницаИдентификационныеДанныеДалее()
	...
	Если СостояниеРегистрациииВСервисе = "Зарегистрирован" Тогда
