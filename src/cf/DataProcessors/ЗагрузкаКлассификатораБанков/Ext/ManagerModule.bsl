...
Функция КлассификаторАктуален() Экспорт
	...
	Если ТекущаяДатаСеанса() > ПоследнееОбновление + ДопустимаяПросрочка 
		И ПолучитьФункциональнуюОпцию("ОтключенныйФункционал") Тогда
...
Функция АктуальностьКлассификатораБанков() Экспорт
	...
	Возврат Результат; // Для РК не поддерживается проверка актуальности классификатора банков.
