...
Процедура УправлениеЭлементами()
	...
	Элементы.ОткрытьОбщероссийскийКлассификаторПродукции.Видимость = ИспользованиеКлассификаторовНоменклатуры
		И ПравоДоступаКлассификаторыОКП И ПолучитьФункциональнуюОпцию("ОтключенныйФункционал");
	Элементы.ОткрытьКлассификаторОКПД2.Видимость	= ПолучитьФункциональнуюОпцию("ОтключенныйФункционал");
	Элементы.ОткрытьКлассификаторОКВЭД2.Видимость	= ПолучитьФункциональнуюОпцию("ОтключенныйФункционал");
	...
	// ИнтеграцияГИСМ
	Элементы.ОткрытьВидыМехаГИСМ.Видимость = ПолучитьФункциональнуюОпцию("ОтключенныйФункционал");
	Элементы.ДекорацияВидыМехаГИСМ.Видимость = ПолучитьФункциональнуюОпцию("ОтключенныйФункционал");
	// Конец ИнтеграцияГИСМ
