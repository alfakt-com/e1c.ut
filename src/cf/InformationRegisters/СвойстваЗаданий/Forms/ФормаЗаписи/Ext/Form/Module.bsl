...
Процедура ЗаполнитьДанныеФормы()
    ...
    Если ЗначениеЗаполнено(Запись.ИдентификаторРезультата) Тогда
      	ДанныеРезультата = РегистрыСведений.ФайлыОбластейДанных.ДвоичныеДанныеФайла(Запись.ИдентификаторРезультата);
    ...
    Если ЗначениеЗаполнено(Запись.ИдентификаторСообщенияОбОшибке) Тогда
      	ДанныеСообщенияОбОшибке = РегистрыСведений.ФайлыОбластейДанных.ДвоичныеДанныеФайла(Запись.ИдентификаторСообщенияОбОшибке);
