...
//
Функция ПолучитьВременныйПароль(ИдентификаторСертификата, ПовторнаяОтправка, СпособДоставкиПаролей) Экспорт
	...
	Попытка
		...
		Результат = СервисКриптографииСлужебный.ВыполнитьМетодКриптосервиса("crypto/password", ПараметрыМетода);
