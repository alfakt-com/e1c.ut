...
//
// Параметры:
//  ТекущиеСтроки		 - 	ДанныеФормыСтруктура, Массив - массив иденетификаторов выделенных строк, либо текущие данные выделенной строки.
...
Процедура ПриОпределенииВозможностиОбновления() Экспорт
	...
	МинимальноДопустимаяВерсия = "3.1.3"; // для УТ11
