...
Функция ПолучитьСтавкуНДСЧислом(Знач СтавкаНДС, НДСпоСтавкам4и2 = Ложь) Экспорт
	...
	Если СтавкаНДС = ПредопределенноеЗначение("Справочник.СтавкиНДС.НДС12") Тогда
		
		Возврат 0.12;
			
	ИначеЕсли СтавкаНДС = ПредопределенноеЗначение("Перечисление.СтавкиНДС.НДС10")
	...
	ИначеЕсли СтавкаНДС = ПредопределенноеЗначение("Справочник.СтавкиНДС.НДС0")
		ИЛИ СтавкаНДС = ПредопределенноеЗначение("Справочник.СтавкиНДС.БезНДС")
		ИЛИ СтавкаНДС = ПредопределенноеЗначение("Справочник.СтавкиНДС.БезНДСНеРК") Тогда
		
		Возврат 0;
		
	Иначе
		
		ЗначениеСтавки = ?(ЗначениеЗаполнено(СтавкаНДС), ЦенообразованиеВызовСервера.РеквизитыСтавкиНДС(СтавкаНДС).Ставка, 0);
