...
Процедура ОбработкаРасшифровки(ЭтаФорма, Элемент, Расшифровка, СтандартнаяОбработка) Экспорт
	...
	// sw begin
	// Швецов Тимур, 21.08.2018
	//ИначеЕсли ПолноеИмяОтчета = "Отчет.swАнализДоступностиТоваровСОценкой" Тогда
	//	
	//	// Расшифровать отчетом -> Поступление и отгрузка товаров
	//	ПараметрыОтчета = Новый Структура;
	//	ПараметрыОтчета.Вставить("Имя",              "ПоступлениеИОтгрузкаТоваров");
	...
	//	МенюОтчетов.Добавить(ПараметрыОтчета);
	//	
	//	// Расшифровать отчетом -> Ведомость по товарам на складах
	//	ПараметрыОтчета = Новый Структура;
	//	ПараметрыОтчета.Вставить("Имя",              "ВедомостьПоТоварамНаСкладах");
	//	ПараметрыОтчета.Вставить("Заголовок",        НСтр("ru = 'Ведомость по товарам на складах'"));
	//	ПараметрыОтчета.Вставить("ИмяОтчета",        "Отчет.ВедомостьПоТоварамНаСкладах");
	//	
	//	ПоляРасшифровки  = Новый Массив;
	//	ПоляРасшифровки.Добавить("Номенклатура");
	//	ПоляРасшифровки.Добавить("Склад");
