...
//		*ПометкаУдаленияДоЗаписи - Булево - значение пометки удаления элемента до записи изменного объекта в базу
//		*ЭтоНовый - Булево
...
//
Функция СвернутьТаблицу(Таблица, Знач КолонкиГруппировок, Знач ДополнительныеАналитики = Неопределено, Знач КолонкиСуммирования = Неопределено) Экспорт
