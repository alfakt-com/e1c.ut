...
Функция СтавкаНДСФискальнойОперации(СтавкаНДС) Экспорт
	...
	ИначеЕсли СтавкаНДС = ПредопределенноеЗначение("Справочник.СтавкиНДС.БезНДСНеРК") Тогда
		ЗначениеСтавкиНДС = Неопределено;
	ИначеЕсли СтавкаНДС = ПредопределенноеЗначение("Справочник.СтавкиНДС.ПустаяСсылка") Тогда
		ЗначениеСтавкиНДС = Неопределено;
	Иначе
...
Процедура УстановитьАктивностьЭлементов(Форма) Экспорт
	...
	Если Форма.ТекущийЭлемент = Форма.Элементы.ПолучательИИН
		И Форма.АктивноеПоле <> Форма.Элементы.ПолучательИИН.Имя Тогда
		
		РозничныеПродажиКлиентСервер.УстановитьАктивныйЭлемент(Форма, Форма.Элементы.ПолучательИИН);
...
Процедура УстановитьАктивныйЭлемент(Форма, Элемент) Экспорт
	...
	МассивЭлементов.Добавить(Форма.Элементы.ПолучательИИН);
