...
Процедура ПриФормированииОчередейОтложенныхОбработчиков(ОбработчикИОчередь) Экспорт
	...
	ОбработчикИОчередь.Вставить("Документы.АктПостановкиНаБалансЕГАИС.ОбработатьДанныеДляПереходаНаНовуюВерсию", 5);
	...
	ОбработчикИОчередь.Вставить("Документы.АктПостановкиНаБалансЕГАИС.ОбработатьДанныеДляПереходаНаНовуюВерсиюГенерацияАкцизныхМарок", 4);
	ОбработчикИОчередь.Вставить("Документы.ТТНВходящаяЕГАИС.ОбработатьДанныеДляПереходаНаНовуюВерсию", 1);
	ОбработчикИОчередь.Вставить("Документы.АктСписанияЕГАИС.ОбработатьДанныеДляПереходаНаНовуюВерсию", 3);
	ОбработчикИОчередь.Вставить("Документы.АктСписанияЕГАИС.ОбработатьДанныеДляПереходаНаНовуюВерсиюГенерацияАкцизныхМарок", 2);
	ОбработчикИОчередь.Вставить("Документы.ЧекЕГАИСВозврат.ОбработатьДанныеДляПереходаНаНовуюВерсию", 7);
	ОбработчикИОчередь.Вставить("Документы.ЧекЕГАИСВозврат.ОбработатьДанныеДляПереходаНаНовуюВерсиюГенерацияАкцизныхМарок", 6);
