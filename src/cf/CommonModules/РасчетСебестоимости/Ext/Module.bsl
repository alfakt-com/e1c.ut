...
Процедура РассчитатьСебестоимостьПоГруппеОрганизаций(ПараметрыЗапуска, ПараметрыРасчета, ПараметрыОтладки)
	...
	Иначе
		...
		УниверсальныеМеханизмыПартийИСебестоимости.УничтожитьВременныеТаблицы(ПараметрыРасчета,
			"ВтУзлыКорректировки, ВТВозвраты, ВТДопРасходов, ЕстьВозвратныеОтходы, РаботыДляДавальца
...
Процедура ЗарегистрироватьСтоимость(ПараметрыРасчета, РегистрацияСтоимостиРегл)
	...
	|	ВЫБОР
	|		КОГДА Остатки.Стоимость / Остатки.Количество < 0
	|			ТОГДА -1
	|			ИНАЧЕ 1
	|	КОНЕЦ 																			 КАК СтоимостьЗнак,
	|	ВЫБОР
	|		КОГДА Остатки.СтоимостьУпр / Остатки.Количество < 0
	|			ТОГДА -1
	|			ИНАЧЕ 1
	|	КОНЕЦ 																			 КАК СтоимостьУпрЗнак
	...
	|
	|	СУММА(Таблица.Стоимость * Таблица.СтоимостьЗнак)    	 		 КАК Стоимость,
	...
	|	СУММА(Таблица.СтоимостьУпр * Таблица.СтоимостьУпрЗнак) 			 КАК СтоимостьУпр,
	...
	|		ТаблицаРешений.СтоимостьЗнак                 КАК СтоимостьЗнак,
	...
	|		ТаблицаРешений.СтоимостьУпрЗнак				 КАК СтоимостьУпрЗнак,
	...
	|		Остатки.СтоимостьЗнак                 КАК СтоимостьЗнак,
	...
	|		Остатки.СтоимостьУпрЗнак			  КАК СтоимостьУпрЗнак,
...
Процедура СформироватьУзлыКорректировкиСписанияСтоимостиРегл(ПараметрыРасчета)
	...
	|	СУММА(ВложенныйЗапрос.Количество)          КАК Количество,
	|	ВЫРАЗИТЬ(
	|		ВЫБОР КОГДА СУММА(ВложенныйЗапрос.Стоимость) < 0 И СУММА(ВложенныйЗапрос.Количество) <> 0 ТОГДА
	|			- ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.Стоимость) КАК ЧИСЛО(28,10)) / СУММА(ВложенныйЗапрос.Количество)
	|		КОГДА СУММА(ВложенныйЗапрос.Количество) <> 0 ТОГДА
	|			ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.Стоимость) КАК ЧИСЛО(28,10)) / СУММА(ВложенныйЗапрос.Количество)
	|		ИНАЧЕ
	...
	|	ВЫРАЗИТЬ(
	|		ВЫБОР КОГДА СУММА(ВложенныйЗапрос.СтоимостьУпр) < 0 И СУММА(ВложенныйЗапрос.Количество) <> 0 ТОГДА
	...
	|	(ВЫБОР
	|		КОГДА СУММА(ВложенныйЗапрос.Стоимость) < 0 ТОГДА -1
	|		ИНАЧЕ 1 КОНЕЦ) КАК СтоимостьЗнак,
	|	(ВЫБОР
	|		КОГДА СУММА(ВложенныйЗапрос.СтоимостьУпр) < 0 ТОГДА -1
	|		ИНАЧЕ 1 КОНЕЦ) КАК СтоимостьУпрЗнак
	|
	|ПОМЕСТИТЬ ВтУзлыКорректировки
	|ИЗ
	|
...
Процедура СписатьОшибкиОкругленияРасчетаСебестоимости(ПараметрыРасчета)
	...
	ПротоколРасчетаПартийИСебестоимости.УвеличитьКоличествоОбработанныхДанныхДляЗамера(
		...
		+ УниверсальныеМеханизмыПартийИСебестоимости.РазмерВременнойТаблицы(ПараметрыРасчета, "ВТОкруглениеРезервыПредстоящихРасходов")
...
Процедура ОтразитьВУправленческомБалансе(ПараметрыРасчета)
	...
	УниверсальныеМеханизмыПартийИСебестоимости.УничтожитьВременныеТаблицы(ПараметрыРасчета,
		"ДокументыКОтражению, ВТВнеоборотныеАктивы, ВТСебестоимость, ВТПрочиеДоходы, ВТПрочиеРасходы, ВТПартииПрочихРасходов, ВТПрочиеРасходыНЗП, ВТАктивыПассивы");
...
Функция ТекстЗапросаДвиженияСтоимости(ПараметрыРасчета)
	...
	|	УзлыКорректировки.СтоимостьЗнак                                         	КАК СтоимостьЗнак,
	|	УзлыКорректировки.СтоимостьУпрЗнак                                      	КАК СтоимостьУпрЗнак,
...
Процедура ПодготовитьДанныеДляРасчетаСтоимостиПоФИФО(ПараметрыРасчета, Запрос)
	...
	|	ТаблицаУзлыКорректировки.СтоимостьЗнак       	    КАК СтоимостьЗнак,
	|	ТаблицаУзлыКорректировки.СтоимостьУпрЗнак    	    КАК СтоимостьУпрЗнак,
	...
	|			ТОГДА 0
	|		ИНАЧЕ (ВЫРАЗИТЬ(ТаблицаУзлыКорректировки.Стоимость * ТаблицаУзлыКорректировки.Количество КАК ЧИСЛО(23,10))
	|			 - ВЫРАЗИТЬ(ЕСТЬNULL(ТаблицаОстатков.СтоимостьОстаток, 0) КАК ЧИСЛО(23,10)))
	|			 	 /(ВЫРАЗИТЬ(ТаблицаУзлыКорректировки.Количество КАК ЧИСЛО(15,3))
	|			 	 	 - ВЫРАЗИТЬ(ЕСТЬNULL(ТаблицаОстатков.КоличествоОстатокНаКонецПериода, 0) КАК ЧИСЛО(15,3))
	|			 	 	  + ВЫРАЗИТЬ(ЕСТЬNULL(ТаблицаОстатков.КоличествоОстаток, 0) КАК ЧИСЛО(15,3)))
	|	КОНЕЦ                                 КАК Стоимость,
	|	ВЫБОР
	|		КОГДА ТаблицаУзлыКорректировки.Количество
	|			 - ЕСТЬNULL(ТаблицаОстатков.КоличествоОстатокНаКонецПериода, 0)
	|			 + ЕСТЬNULL(ТаблицаОстатков.КоличествоОстаток, 0) = 0
	|			ТОГДА 0
	|		ИНАЧЕ (ВЫРАЗИТЬ(ТаблицаУзлыКорректировки.СтоимостьБезНДС * ТаблицаУзлыКорректировки.Количество КАК ЧИСЛО(23,10))
	|			 - ВЫРАЗИТЬ(ЕСТЬNULL(ТаблицаОстатков.СтоимостьБезНДСОстаток, 0) КАК ЧИСЛО(23,10))) 
	|			 	 /(ВЫРАЗИТЬ(ТаблицаУзлыКорректировки.Количество КАК ЧИСЛО(15,3))
	|			 	 	 - ВЫРАЗИТЬ(ЕСТЬNULL(ТаблицаОстатков.КоличествоОстатокНаКонецПериода, 0) КАК ЧИСЛО(15,3))
	|			 	 	  + ВЫРАЗИТЬ(ЕСТЬNULL(ТаблицаОстатков.КоличествоОстаток, 0) КАК ЧИСЛО(15,3)))
	|	КОНЕЦ                                 КАК СтоимостьБезНДС,
	...
	|			 + ЕСТЬNULL(ТаблицаОстатков.КоличествоОстаток, 0) = 0
	|			ТОГДА 0
	|		ИНАЧЕ (ВЫРАЗИТЬ(ТаблицаУзлыКорректировки.СтоимостьЗабалансовая * ТаблицаУзлыКорректировки.Количество КАК ЧИСЛО(23,10))
	|			 - ВЫРАЗИТЬ(ЕСТЬNULL(ТаблицаОстатков.СтоимостьЗабалансоваяОстаток, 0) КАК ЧИСЛО(23,10))) 
	|			 	 /(ВЫРАЗИТЬ(ТаблицаУзлыКорректировки.Количество КАК ЧИСЛО(15,3))
	|			 	 	 - ВЫРАЗИТЬ(ЕСТЬNULL(ТаблицаОстатков.КоличествоОстатокНаКонецПериода, 0) КАК ЧИСЛО(15,3))
	|			 	 	  + ВЫРАЗИТЬ(ЕСТЬNULL(ТаблицаОстатков.КоличествоОстаток, 0) КАК ЧИСЛО(15,3)))
	|	КОНЕЦ                                 КАК СтоимостьЗабалансовая,
	...
	|			 + ЕСТЬNULL(ТаблицаОстатков.КоличествоОстаток, 0) = 0
	|			ТОГДА 0
	|		ИНАЧЕ (ВЫРАЗИТЬ(ТаблицаУзлыКорректировки.ПостояннаяРазница * ТаблицаУзлыКорректировки.Количество КАК ЧИСЛО(23,10))
	|			 - ВЫРАЗИТЬ(ЕСТЬNULL(ТаблицаОстатков.ПостояннаяРазницаОстаток, 0) КАК ЧИСЛО(23,10)))
	|			 	 /(ВЫРАЗИТЬ(ТаблицаУзлыКорректировки.Количество КАК ЧИСЛО(15,3))
	|			 	 	 - ВЫРАЗИТЬ(ЕСТЬNULL(ТаблицаОстатков.КоличествоОстатокНаКонецПериода, 0) КАК ЧИСЛО(15,3))
	|			 	 	  + ВЫРАЗИТЬ(ЕСТЬNULL(ТаблицаОстатков.КоличествоОстаток, 0) КАК ЧИСЛО(15,3)))
	|	КОНЕЦ                                 КАК ПостояннаяРазница,
	...
	|			 + ЕСТЬNULL(ТаблицаОстатков.КоличествоОстаток, 0) = 0
	|			ТОГДА 0
	|		ИНАЧЕ (ВЫРАЗИТЬ(ТаблицаУзлыКорректировки.ВременнаяРазница * ТаблицаУзлыКорректировки.Количество КАК ЧИСЛО(23,10))
	|			 - ВЫРАЗИТЬ(ЕСТЬNULL(ТаблицаОстатков.ВременнаяРазницаОстаток, 0) КАК ЧИСЛО(23,10))) 
	|			 	 /(ВЫРАЗИТЬ(ТаблицаУзлыКорректировки.Количество КАК ЧИСЛО(15,3))
	|			 	 	 - ВЫРАЗИТЬ(ЕСТЬNULL(ТаблицаОстатков.КоличествоОстатокНаКонецПериода, 0) КАК ЧИСЛО(15,3))
	|			 	 	  + ВЫРАЗИТЬ(ЕСТЬNULL(ТаблицаОстатков.КоличествоОстаток, 0) КАК ЧИСЛО(15,3)))
	|	КОНЕЦ                                 КАК ВременнаяРазница,
	...
	|			ТОГДА 0	
	|		ИНАЧЕ (ВЫРАЗИТЬ(ТаблицаУзлыКорректировки.СтоимостьДопРасходы * ТаблицаУзлыКорректировки.Количество КАК ЧИСЛО(23,10))
	|			 - ВЫРАЗИТЬ(ЕСТЬNULL(ТаблицаОстатков.СтоимостьДопРасходыОстаток, 0) КАК ЧИСЛО(15,3))) 
	|			 	 /(ВЫРАЗИТЬ(ТаблицаУзлыКорректировки.Количество КАК ЧИСЛО(15,3))
	|			 	 	 - ВЫРАЗИТЬ(ЕСТЬNULL(ТаблицаОстатков.КоличествоОстатокНаКонецПериода, 0) КАК ЧИСЛО(15,3)))
	|	КОНЕЦ                                 КАК СтоимостьДопРасходы,
	|	ВЫБОР
	...
	|			И ЕСТЬNULL(ТаблицаОстатков.КоличествоОстатокНаКонецПериода, 0) <> 0
	|			ТОГДА 0	
	|		ИНАЧЕ (ВЫРАЗИТЬ(ТаблицаУзлыКорректировки.СтоимостьДопРасходыБезНДС * ТаблицаУзлыКорректировки.Количество КАК ЧИСЛО(23,10))
	|			 - ВЫРАЗИТЬ(ЕСТЬNULL(ТаблицаОстатков.СтоимостьДопРасходыБезНДСОстаток, 0) КАК ЧИСЛО(23,10))) 
	|			 	 /(ВЫРАЗИТЬ(ТаблицаУзлыКорректировки.Количество КАК ЧИСЛО(15,3))
	|			 	 	 - ВЫРАЗИТЬ(ЕСТЬNULL(ТаблицаОстатков.КоличествоОстатокНаКонецПериода, 0) КАК ЧИСЛО(15,3)))
	|	КОНЕЦ                                 КАК СтоимостьДопРасходыБезНДС,
	|	ВЫБОР
	...
	|			И ЕСТЬNULL(ТаблицаОстатков.КоличествоОстатокНаКонецПериода, 0) <> 0
	|			ТОГДА 0	
	|		ИНАЧЕ (ВЫРАЗИТЬ(ТаблицаУзлыКорректировки.Трудозатраты * ТаблицаУзлыКорректировки.Количество КАК ЧИСЛО(23,10))
	|			 - ВЫРАЗИТЬ(ЕСТЬNULL(ТаблицаОстатков.ТрудозатратыОстаток, 0) КАК ЧИСЛО(23,10))) 
	|			 	 /(ВЫРАЗИТЬ(ТаблицаУзлыКорректировки.Количество КАК ЧИСЛО(15,3))
	|			 	 	 - ВЫРАЗИТЬ(ЕСТЬNULL(ТаблицаОстатков.КоличествоОстатокНаКонецПериода, 0) КАК ЧИСЛО(15,3)))
	|	КОНЕЦ                                 КАК Трудозатраты,
	|	ВЫБОР
	...
	|			И ЕСТЬNULL(ТаблицаОстатков.КоличествоОстатокНаКонецПериода, 0) <> 0
	|			ТОГДА 0	
	|		ИНАЧЕ (ВЫРАЗИТЬ(ТаблицаУзлыКорректировки.ПостатейныеПостоянныеСНДС * ТаблицаУзлыКорректировки.Количество КАК ЧИСЛО(23,10))
	|			 - ВЫРАЗИТЬ(ЕСТЬNULL(ТаблицаОстатков.ПостатейныеПостоянныеСНДСОстаток, 0) КАК ЧИСЛО(23,10))) 
	|			 	 /(ВЫРАЗИТЬ(ТаблицаУзлыКорректировки.Количество КАК ЧИСЛО(15,3))
	|			 	 	 - ВЫРАЗИТЬ(ЕСТЬNULL(ТаблицаОстатков.КоличествоОстатокНаКонецПериода, 0) КАК ЧИСЛО(15,3)))
	|	КОНЕЦ                                 КАК ПостатейныеПостоянныеСНДС,
	|	ВЫБОР
	...
	|			И ЕСТЬNULL(ТаблицаОстатков.КоличествоОстатокНаКонецПериода, 0) <> 0
	|			ТОГДА 0	
	|		ИНАЧЕ (ВЫРАЗИТЬ(ТаблицаУзлыКорректировки.ПостатейныеПостоянныеБезНДС * ТаблицаУзлыКорректировки.Количество КАК ЧИСЛО(23,10))
	|			 -ВЫРАЗИТЬ(ЕСТЬNULL(ТаблицаОстатков.ПостатейныеПостоянныеБезНДСОстаток, 0) КАК ЧИСЛО(23,10))) 
	|			 	 /(ВЫРАЗИТЬ(ТаблицаУзлыКорректировки.Количество КАК ЧИСЛО(15,3))
	|			 	 	 - ВЫРАЗИТЬ(ЕСТЬNULL(ТаблицаОстатков.КоличествоОстатокНаКонецПериода, 0) КАК ЧИСЛО(15,3)))
	|	КОНЕЦ                                 КАК ПостатейныеПостоянныеБезНДС,
	|	ВЫБОР
	...
	|			И ЕСТЬNULL(ТаблицаОстатков.КоличествоОстатокНаКонецПериода, 0) <> 0
	|			ТОГДА 0	
	|		ИНАЧЕ (ВЫРАЗИТЬ(ТаблицаУзлыКорректировки.ПостатейныеПеременныеБезНДС * ТаблицаУзлыКорректировки.Количество КАК ЧИСЛО(23,10))
	|			 - ВЫРАЗИТЬ(ЕСТЬNULL(ТаблицаОстатков.ПостатейныеПеременныеБезНДСОстаток, 0) КАК ЧИСЛО(23,10))) 
	|			 	 /(ВЫРАЗИТЬ(ТаблицаУзлыКорректировки.Количество КАК ЧИСЛО(15,3))
	|			 	 	 - ВЫРАЗИТЬ(ЕСТЬNULL(ТаблицаОстатков.КоличествоОстатокНаКонецПериода, 0) КАК ЧИСЛО(15,3)))
	|	КОНЕЦ                                 КАК ПостатейныеПеременныеСНДС,
	|	ВЫБОР
...
Процедура ПодготовитьДанныеДляРасчетаСтоимостиРеглПоФИФО(ПараметрыРасчета, Запрос)
	...
	|	ТОГДА
	|		0
	|	КОГДА (ВЫРАЗИТЬ(ТаблицаУзлыКорректировки.Стоимость КАК ЧИСЛО(23,10))
	|			* ВЫРАЗИТЬ(ТаблицаУзлыКорректировки.Количество КАК ЧИСЛО(15,3))
	|			- ВЫРАЗИТЬ(ЕСТЬNULL(ТаблицаОстатков.СтоимостьРеглОстаток, 0) КАК ЧИСЛО(23,10))) = 0
	|		И ЕСТЬNULL(ТаблицаОстатков.КоличествоОстатокНаКонецПериода, 0) <> 0
	|		ТОГДА 0	
	|	ИНАЧЕ
	|		(ВЫРАЗИТЬ(ТаблицаУзлыКорректировки.Стоимость КАК ЧИСЛО(23,10))
	|			* ВЫРАЗИТЬ(ТаблицаУзлыКорректировки.Количество КАК ЧИСЛО(15,3))
	|		- ВЫРАЗИТЬ(ЕСТЬNULL(ТаблицаОстатков.СтоимостьРеглОстаток, 0) КАК ЧИСЛО(23,10)))
	|		/(ВЫРАЗИТЬ(ТаблицаУзлыКорректировки.Количество КАК ЧИСЛО(15,3))
	|		- ВЫРАЗИТЬ(ЕСТЬNULL(ТаблицаОстатков.КоличествоОстатокНаКонецПериода, 0) КАК ЧИСЛО(15,3))
	|		+ ВЫРАЗИТЬ(ЕСТЬNULL(ТаблицаОстатков.КоличествоОстаток, 0) КАК ЧИСЛО(15,3)))
	|	КОНЕЦ)
	...
	|		ТОГДА 0	
	|	ИНАЧЕ
	|		(ВЫРАЗИТЬ(ТаблицаУзлыКорректировки.СтоимостьДопРасходы КАК ЧИСЛО(23,10))
	|			* ВЫРАЗИТЬ(ТаблицаУзлыКорректировки.Количество КАК ЧИСЛО(15,3))
	|		- ВЫРАЗИТЬ(ЕСТЬNULL(ТаблицаОстатков.СтоимостьДопРасходыОстаток, 0) КАК ЧИСЛО(23,10)))
	|		/(ВЫРАЗИТЬ(ТаблицаУзлыКорректировки.Количество КАК ЧИСЛО(15,3))
	|		- ВЫРАЗИТЬ(ЕСТЬNULL(ТаблицаОстатков.КоличествоОстатокНаКонецПериода, 0) КАК ЧИСЛО(15,3)))
	|	КОНЕЦ) КАК Стоимость,
	|
...
Процедура РешитьСЛУ(ПараметрыРасчета, РасчетСтоимостиРегл)
	...
	|				* ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.СтоимостьЗнак, 0) КАК ЧИСЛО(28,10))
	...
	|					ТОГДА ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.Стоимость, 0) КАК ЧИСЛО(28,10)) + ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.Трудозатраты, 0) КАК ЧИСЛО(28,10))
	|				ИНАЧЕ 0 КОНЕЦ
	|			+ ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ПостатейныеПостоянныеСНДС, 0) КАК ЧИСЛО(28,10)))
	|			* ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(28,10))
	|		КОНЕЦ) КАК ЧИСЛО(28,10))
	...
	|			(ВЫБОР
	|				КОГДА ЕСТЬNULL(ПеремещенияСписания.ПостатейныеПостоянные, ЛОЖЬ)
	|					ТОГДА ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.СтоимостьБезНДС, 0) КАК ЧИСЛО(28,10)) + ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.Трудозатраты, 0) КАК ЧИСЛО(28,10))
	|				ИНАЧЕ 0 КОНЕЦ
	...
	|				* ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.СтоимостьУпрЗнак, 0) КАК ЧИСЛО(28,10))
	|				* ВЫРАЗИТЬ(ЕСТЬNULL(ПеремещенияСписания.Количество, 0) КАК ЧИСЛО(28,10))
	|			КОНЕЦ) КАК ЧИСЛО(28,10))
	...
	|					ТОГДА ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.СтоимостьУпр, 0) КАК ЧИСЛО(28,10)) + ВЫРАЗИТЬ(ЕСТЬNULL(ВтТаблицаРешений.ТрудозатратыУпр, 0) КАК ЧИСЛО(28,10))
	|				ИНАЧЕ 0 КОНЕЦ
	...
	|	ЕСТЬNULL(
	|		МАКСИМУМ(
	|			ВЫБОР КОГДА (ЕСТЬNULL(ТаблицаРешений.Стоимость * ТаблицаРешений.СтоимостьЗнак,0)
	|			 - (УзлыКорректировки.Стоимость * УзлыКорректировки.СтоимостьЗнак
	|				+ ВременнаяТаблицаРешений.Стоимость)) > 0 ТОГДА
	|
	|				ЕСТЬNULL(ТаблицаРешений.Стоимость * ТаблицаРешений.СтоимостьЗнак,0)
	|				- (УзлыКорректировки.Стоимость * УзлыКорректировки.СтоимостьЗнак
	...
	|	ЕСТЬNULL(
	|		МАКСИМУМ(
	|			ВЫБОР КОГДА (ЕСТЬNULL(ТаблицаРешений.СтоимостьБезНДС,0) - (УзлыКорректировки.СтоимостьБезНДС
	|			 + ВременнаяТаблицаРешений.СтоимостьБезНДС)) > 0 ТОГДА
	|
	|					ЕСТЬNULL(ТаблицаРешений.СтоимостьБезНДС,0) - (УзлыКорректировки.СтоимостьБезНДС
	...
	|	ЕСТЬNULL(
	|		МАКСИМУМ(
	|			ВЫБОР КОГДА (ЕСТЬNULL(ТаблицаРешений.СтоимостьДопРасходы,0) - (УзлыКорректировки.СтоимостьДопРасходы
	|					 + ВременнаяТаблицаРешений.СтоимостьДопРасходы)) >  0 ТОГДА
	|
	|					ЕСТЬNULL(ТаблицаРешений.СтоимостьДопРасходы,0) - (УзлыКорректировки.СтоимостьДопРасходы
	...
	|	ЕСТЬNULL(
	|		МАКСИМУМ(
	|			ВЫБОР КОГДА (ЕСТЬNULL(ТаблицаРешений.СтоимостьДопРасходыБезНДС,0) - (УзлыКорректировки.СтоимостьДопРасходыБезНДС
	|					 + ВременнаяТаблицаРешений.СтоимостьДопРасходыБезНДС)) > 0 ТОГДА
	|
	|					ЕСТЬNULL(ТаблицаРешений.СтоимостьДопРасходыБезНДС,0) - (УзлыКорректировки.СтоимостьДопРасходыБезНДС
	...
	|	ЕСТЬNULL(
	|		МАКСИМУМ(
	|			ВЫБОР КОГДА (ЕСТЬNULL(ТаблицаРешений.СтоимостьЗабалансовая,0) - (УзлыКорректировки.СтоимостьЗабалансовая
	...
	|	ЕСТЬNULL(
	|		МАКСИМУМ(
	|			ВЫБОР КОГДА (ЕСТЬNULL(ТаблицаРешений.Трудозатраты,0) - (УзлыКорректировки.Трудозатраты
	|			 + ВременнаяТаблицаРешений.Трудозатраты)) > 0 ТОГДА
	|
	|					ЕСТЬNULL(ТаблицаРешений.Трудозатраты,0) - (УзлыКорректировки.Трудозатраты
	...
	|	ЕСТЬNULL(
	|		МАКСИМУМ(
	|			ВЫБОР КОГДА (ЕСТЬNULL(ТаблицаРешений.ПостатейныеПостоянныеСНДС,0) - (УзлыКорректировки.ПостатейныеПостоянныеСНДС
	|			 + ВременнаяТаблицаРешений.ПостатейныеПостоянныеСНДС)) > 0 ТОГДА
	|
	|					ЕСТЬNULL(ТаблицаРешений.ПостатейныеПостоянныеСНДС,0) - (УзлыКорректировки.ПостатейныеПостоянныеСНДС
	...
	|	ЕСТЬNULL(
	|		МАКСИМУМ(
	|			ВЫБОР КОГДА (ЕСТЬNULL(ТаблицаРешений.ПостатейныеПостоянныеБезНДС,0) - (УзлыКорректировки.ПостатейныеПостоянныеБезНДС
	|			 + ВременнаяТаблицаРешений.ПостатейныеПостоянныеБезНДС)) > 0 ТОГДА
	|
	|					ЕСТЬNULL(ТаблицаРешений.ПостатейныеПостоянныеБезНДС,0) - (УзлыКорректировки.ПостатейныеПостоянныеБезНДС
	...
	|	ЕСТЬNULL(
	|		МАКСИМУМ(
	|			ВЫБОР КОГДА (ЕСТЬNULL(ТаблицаРешений.ПостатейныеПеременныеСНДС,0) - (УзлыКорректировки.ПостатейныеПеременныеСНДС
	|			 + ВременнаяТаблицаРешений.ПостатейныеПеременныеСНДС)) > 0 ТОГДА
	|
	|					ЕСТЬNULL(ТаблицаРешений.ПостатейныеПеременныеСНДС,0) - (УзлыКорректировки.ПостатейныеПеременныеСНДС
	...
	|	ЕСТЬNULL(
	|		МАКСИМУМ(
	|			ВЫБОР КОГДА (ЕСТЬNULL(ТаблицаРешений.ПостатейныеПеременныеБезНДС,0) - (УзлыКорректировки.ПостатейныеПеременныеБезНДС
	|			 + ВременнаяТаблицаРешений.ПостатейныеПеременныеБезНДС)) > 0 ТОГДА
	|
	|					ЕСТЬNULL(ТаблицаРешений.ПостатейныеПеременныеБезНДС,0) - (УзлыКорректировки.ПостатейныеПеременныеБезНДС
	...
	|	ЕСТЬNULL(
	|		МАКСИМУМ(
	|			ВЫБОР КОГДА (ЕСТЬNULL(ТаблицаРешений.СтоимостьУпр * ТаблицаРешений.СтоимостьУпрЗнак,0)
	|			 - (УзлыКорректировки.СтоимостьУпр * УзлыКорректировки.СтоимостьУпрЗнак
	|				+ ВременнаяТаблицаРешений.СтоимостьУпр)) > 0 ТОГДА
	|
	|				ЕСТЬNULL(ТаблицаРешений.СтоимостьУпр * ТаблицаРешений.СтоимостьУпрЗнак,0)
	|				- (УзлыКорректировки.СтоимостьУпр * УзлыКорректировки.СтоимостьУпрЗнак
	...
	|	ЕСТЬNULL(
	|		МАКСИМУМ(
	|			ВЫБОР КОГДА (ЕСТЬNULL(ТаблицаРешений.ДопРасходыУпр,0) - (УзлыКорректировки.ДопРасходыУпр
	|			 + ВременнаяТаблицаРешений.ДопРасходыУпр)) > 0 ТОГДА
	|
	|					ЕСТЬNULL(ТаблицаРешений.ДопРасходыУпр,0) - (УзлыКорректировки.ДопРасходыУпр
	...
	|	ЕСТЬNULL(
	|		МАКСИМУМ(
	|			ВЫБОР КОГДА (ЕСТЬNULL(ТаблицаРешений.ТрудозатратыУпр,0) - (УзлыКорректировки.ТрудозатратыУпр
	|			 + ВременнаяТаблицаРешений.ТрудозатратыУпр)) > 0 ТОГДА
	|
	|					ЕСТЬNULL(ТаблицаРешений.ТрудозатратыУпр,0) - (УзлыКорректировки.ТрудозатратыУпр
	...
	|	ЕСТЬNULL(
	|		МАКСИМУМ(
	|			ВЫБОР КОГДА (ЕСТЬNULL(ТаблицаРешений.ПостатейныеПостоянныеУпр,0) - (УзлыКорректировки.ПостатейныеПостоянныеУпр
	|			 + ВременнаяТаблицаРешений.ПостатейныеПостоянныеУпр)) > 0 ТОГДА
	|
	|					ЕСТЬNULL(ТаблицаРешений.ПостатейныеПостоянныеУпр,0) - (УзлыКорректировки.ПостатейныеПостоянныеУпр
	...
	|	ЕСТЬNULL(
	|		МАКСИМУМ(
	|			ВЫБОР КОГДА (ЕСТЬNULL(ТаблицаРешений.ПостатейныеПеременныеУпр,0) - (УзлыКорректировки.ПостатейныеПеременныеУпр
	|			 + ВременнаяТаблицаРешений.ПостатейныеПеременныеУпр)) > 0 ТОГДА
	|
	|					ЕСТЬNULL(ТаблицаРешений.ПостатейныеПеременныеУпр,0) - (УзлыКорректировки.ПостатейныеПеременныеУпр
	...
	|	ВЫБОР
	|	 	КОГДА УзлыКорректировки.Стоимость * УзлыКорректировки.СтоимостьЗнак + ВременнаяТаблицаРешений.Стоимость < 0
	|			ТОГДА -1
	|			ИНАЧЕ 1
    |	КОНЕЦ КАК СтоимостьЗнак,
	
	|	ВЫБОР
	|	 	КОГДА УзлыКорректировки.СтоимостьУпр * УзлыКорректировки.СтоимостьУпрЗнак + ВременнаяТаблицаРешений.СтоимостьУпр < 0
	|			ТОГДА -1
	|			ИНАЧЕ 1
    |	КОНЕЦ КАК СтоимостьУпрЗнак,
	...
	|	ВЫРАЗИТЬ(ВЫБОР
	|	 	КОГДА УзлыКорректировки.Стоимость * УзлыКорректировки.СтоимостьЗнак + ВременнаяТаблицаРешений.Стоимость < 0
	|			ТОГДА -(УзлыКорректировки.Стоимость * УзлыКорректировки.СтоимостьЗнак + ВременнаяТаблицаРешений.Стоимость)
	|			ИНАЧЕ УзлыКорректировки.Стоимость * УзлыКорректировки.СтоимостьЗнак + ВременнаяТаблицаРешений.Стоимость
    |	КОНЕЦ КАК ЧИСЛО(28,10)) КАК Стоимость,
	|	ВЫРАЗИТЬ(
	|		УзлыКорректировки.СтоимостьБезНДС
	|			+ ВременнаяТаблицаРешений.СтоимостьБезНДС
	|		КАК ЧИСЛО(28,10))              КАК СтоимостьБезНДС,
	|	ВЫРАЗИТЬ(ВЫБОР
	|	 	КОГДА УзлыКорректировки.ВременнаяРазница * УзлыКорректировки.ВременнаяРазницаЗнак + ВременнаяТаблицаРешений.ВременнаяРазница < 0
	...
	|
	|	ВЫРАЗИТЬ(
	|		УзлыКорректировки.СтоимостьДопРасходы
	|			+ ВременнаяТаблицаРешений.СтоимостьДопРасходы 
	|		КАК ЧИСЛО(28,10))              КАК СтоимостьДопРасходы,
	|	ВЫРАЗИТЬ(
	|		УзлыКорректировки.СтоимостьДопРасходыБезНДС
	|			+ ВременнаяТаблицаРешений.СтоимостьДопРасходыБезНДС 
	|		КАК ЧИСЛО(28,10))              КАК СтоимостьДопРасходыБезНДС,
	|
	|	ВЫРАЗИТЬ(
	|		УзлыКорректировки.СтоимостьЗабалансовая
	|			+ ВременнаяТаблицаРешений.СтоимостьЗабалансовая
	|		КАК ЧИСЛО(28,10))              КАК СтоимостьЗабалансовая,
	|	ВЫРАЗИТЬ(
	|		УзлыКорректировки.Трудозатраты
	|			+ ВременнаяТаблицаРешений.Трудозатраты
	|		КАК ЧИСЛО(28,10))              КАК Трудозатраты,
	|	ВЫРАЗИТЬ(
	|		УзлыКорректировки.ПостатейныеПостоянныеСНДС
	|			+ ВременнаяТаблицаРешений.ПостатейныеПостоянныеСНДС
	|		КАК ЧИСЛО(28,10))              КАК ПостатейныеПостоянныеСНДС,
	|	ВЫРАЗИТЬ(
	|		УзлыКорректировки.ПостатейныеПостоянныеБезНДС
	|			+ ВременнаяТаблицаРешений.ПостатейныеПостоянныеБезНДС
	|		КАК ЧИСЛО(28,10))              КАК ПостатейныеПостоянныеБезНДС,
	|	ВЫРАЗИТЬ(
	|		УзлыКорректировки.ПостатейныеПеременныеСНДС
	|			+ ВременнаяТаблицаРешений.ПостатейныеПеременныеСНДС
	|		КАК ЧИСЛО(28,10))              КАК ПостатейныеПеременныеСНДС,
	|	ВЫРАЗИТЬ(
	|		УзлыКорректировки.ПостатейныеПеременныеБезНДС
	|			+ ВременнаяТаблицаРешений.ПостатейныеПеременныеБезНДС
	|		КАК ЧИСЛО(28,10))              КАК ПостатейныеПеременныеБезНДС,
	
	|	ВЫРАЗИТЬ(ВЫБОР
	|	 	КОГДА УзлыКорректировки.СтоимостьУпр * УзлыКорректировки.СтоимостьУпрЗнак + ВременнаяТаблицаРешений.СтоимостьУпр < 0
	|			ТОГДА -(УзлыКорректировки.СтоимостьУпр * УзлыКорректировки.СтоимостьУпрЗнак + ВременнаяТаблицаРешений.СтоимостьУпр)
	|			ИНАЧЕ УзлыКорректировки.СтоимостьУпр * УзлыКорректировки.СтоимостьУпрЗнак + ВременнаяТаблицаРешений.СтоимостьУпр
    |	КОНЕЦ КАК ЧИСЛО(28,10)) КАК СтоимостьУпр,
	|	ВЫРАЗИТЬ(
	|		УзлыКорректировки.ДопРасходыУпр
	|			+ ВременнаяТаблицаРешений.ДопРасходыУпр
	|		КАК ЧИСЛО(28,10))              КАК ДопРасходыУпр,
	|	ВЫРАЗИТЬ(
	|		УзлыКорректировки.ТрудозатратыУпр
	|			+ ВременнаяТаблицаРешений.ТрудозатратыУпр
	|		КАК ЧИСЛО(28,10))              КАК ТрудозатратыУпр,
	|	ВЫРАЗИТЬ(
	|		УзлыКорректировки.ПостатейныеПостоянныеУпр
	|			+ ВременнаяТаблицаРешений.ПостатейныеПостоянныеУпр
	|		КАК ЧИСЛО(28,10))              КАК ПостатейныеПостоянныеУпр,
	|	ВЫРАЗИТЬ(
...
Процедура СохранитьДанныеСЛУ(ПараметрыРасчета, РасчетСтоимостиРегл)
	...
	Если ФорматВыгрузки = "mxl" Тогда
		...
		|
		|	УзлыКорректировки.Стоимость * УзлыКорректировки.СтоимостьЗнак КАК УзелСтоимость,
		...
		|	УзлыКорректировки.СтоимостьУпр * УзлыКорректировки.СтоимостьУпрЗнак КАК УзелСтоимостьУпр,
		...
		|
		|	ТаблицаРешений.Стоимость * ТаблицаРешений.СтоимостьЗнак КАК РешениеСтоимость,
		...
		|	ТаблицаРешений.СтоимостьУпр * ТаблицаРешений.СтоимостьУпрЗнак КАК РешениеСтоимостьУпр,
