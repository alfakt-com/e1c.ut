...
Процедура ПриПолученииРезультатаСозданияЗаявки(Результат, ДополнительныеПараметры) Экспорт
	...
	ИначеЕсли Результат.Действие = "ОтправитьЗаявку" Тогда
		...
		СертификатЭП = Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(
...
Функция СессионныеПараметрыДляРасшифрования(КСКонтекст)
	...
	Результат.Вставить("markerED",
		Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "markerED"));
	Результат.Вставить("IDCertificateED_Dop",
		Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "IDCertificateED_Dop"));
	Результат.Вставить("IDCertificateED",
		Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "IDCertificateED"));
...
Функция ТекстТехническихПараметровЭДО(КонтекстВзаимодействия, Знач Сертификат = Неопределено) Экспорт
	...
	Если НЕ ЗначениеЗаполнено(Сертификат) Тогда
		Сертификат = Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(
			КонтекстВзаимодействия.КСКонтекст,
			"IDCertificateED");
	КонецЕсли;
	...
	КодОшибки = Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(
		КонтекстВзаимодействия.КСКонтекст,
		"codeErrorED");
	ТекстОшибки = Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(
		КонтекстВзаимодействия.КСКонтекст,
		"textErrorED");
...
Процедура ВыполнитьСценарий(
	...
	Исключение
		...
		Если КонтекстВзаимодействия <> Неопределено Тогда
			...
			Логин = Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(
				КонтекстВзаимодействия.КСКонтекст,
				"login");
...
Процедура ОбработкаКомандСервиса(
	...
	Если КонтекстОбработчика = Неопределено Тогда
		...
		КонтекстОбработчика = Подключение1СТакскомКлиентСервер.НовыйКонтекстОбработчикаКоманд();
	КонецЕсли;
...
Процедура ПередОткрытиемФормы(
	...
	Если ИмяОткрываемойФормы = "Обработка.Подключение1СТакском.Форма.УникальныйИдентификаторАбонента" Тогда
		...
		Иначе
			...
			ПараметрыСобытия.Вставить("КодОшибки",
				Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "codeErrorED"));
			ПараметрыСобытия.Вставить("ОписаниеОшибки",
				Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "textErrorED"));
			
			ДанныеЗаявки = Новый Структура;
			ДанныеЗаявки.Вставить("ИдентификаторАбонента",
				Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "identifierTaxcomED"));
			ДанныеЗаявки.Вставить("ОтпечатокСертификата",
				Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "certificatefingerprintED"));
			ДанныеЗаявки.Вставить("Индекс",
				Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "postindexED"));
			ДанныеЗаявки.Вставить("КодРегиона",
				Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "codregionED"));
			ДанныеЗаявки.Вставить("Район",
				Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "addresstownshipED"));
			ДанныеЗаявки.Вставить("Город",
				Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "addresscityED"));
			ДанныеЗаявки.Вставить("НаселенныйПункт",
				Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "addresslocalityED"));
			ДанныеЗаявки.Вставить("Улица",
				Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "addressstreetED"));
			ДанныеЗаявки.Вставить("Дом",
				Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "addressbuildingED"));
			ДанныеЗаявки.Вставить("Корпус",
				Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "addresshousingED"));
			ДанныеЗаявки.Вставить("Квартира",
				Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "addressapartmentED"));
			ДанныеЗаявки.Вставить("Телефон",
				Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "addressphoneED"));
			ДанныеЗаявки.Вставить("НаименованиеОрганизации",
				Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "agencyED"));
			ДанныеЗаявки.Вставить("ИНН",
				Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "innED"));
			ДанныеЗаявки.Вставить("КПП",
				Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "kppED"));
			ДанныеЗаявки.Вставить("ОГРН",
				Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "ogrnED"));
			ДанныеЗаявки.Вставить("КодНалоговогоОргана",
				Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "codeimnsED"));
			ДанныеЗаявки.Вставить("ЮрФизЛицо",
				Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "orgindED"));
			ДанныеЗаявки.Вставить("Фамилия",
				Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "lastnameED"));
			ДанныеЗаявки.Вставить("Имя",
				Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "firstnameED"));
			ДанныеЗаявки.Вставить("Отчество",
				Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "middlenameED"));
...
Процедура ОткрытьВнутреннююФорму(
	...
	Если ТекстФормы <> Неопределено Тогда
		Если СтрНайти(ТекстФормы, "%Логин%") Тогда
			СтрокаЗамены = Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(
				КонтекстВзаимодействия.КСКонтекст,
				"login");
...
Функция СформироватьПараметрыОткрытияФормы(КСКонтекст, ИмяОткрываемойФормы)
	...
	ПараметрыНовойФормы.Вставить("login",
		Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "login"));
	...
	Если ИмяОткрываемойФормы = "Обработка.Подключение1СТакском.Форма.ПодключениеИнтернетПоддержки" Тогда
		...
		ПараметрыНовойФормы.Вставить("ЗапомнитьПароль",
			Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст,"savePassword") <> "false");
	...
	ИначеЕсли ИмяОткрываемойФормы = "Обработка.Подключение1СТакском.Форма.ОбщаяРегНомер" Тогда
		ПараметрыНовойФормы.Вставить("regnumber",
			Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст,"regnumber"));
	...
	ИначеЕсли ИмяОткрываемойФормы = "Обработка.Подключение1СТакском.Форма.ОбщаяПинкод" Тогда
		...
		ПараметрыНовойФормы.Вставить("pincode",
			Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст,"pincode"));
	...
	ИначеЕсли ИмяОткрываемойФормы = "Обработка.Подключение1СТакском.Форма.УникальныйИдентификаторАбонента" Тогда
		ПараметрыНовойФормы.Вставить("applicationStatusED",
			Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "applicationStatusED"));
		ПараметрыНовойФормы.Вставить("numberRequestED",
			Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "numberRequestED"));
		ПараметрыНовойФормы.Вставить("identifierTaxcomED",
			Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "identifierTaxcomED"));
		ПараметрыНовойФормы.Вставить("dateRequestED",
			Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "dateRequestED"));
		ПараметрыНовойФормы.Вставить("IDCertificateED",
			Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "IDCertificateED"));
		ПараметрыНовойФормы.Вставить("IDOrganizationED",
			Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "IDOrganizationED"));
		ПараметрыНовойФормы.Вставить("ToAddCert",
			Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "ToAddCert"));
	...
	ИначеЕсли ИмяОткрываемойФормы = "Обработка.Подключение1СТакском.Форма.ЗаявкаНаРегистрациюАбонента" Тогда
		ПараметрыНовойФормы.Вставить("statusApplicationFormED",
			Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "statusApplicationFormED"));
		ПараметрыНовойФормы.Вставить("numberRequestED",
			Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "numberRequestED"));
		ПараметрыНовойФормы.Вставить("dateRequestED",
			Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "dateRequestED"));
		...
		ПараметрыНовойФормы.Вставить("nameCertificateED",
			Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "nameCertificateED"));
		...
		ПараметрыНовойФормы.Вставить("addressregionED",
			Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "addressregionED"));
	...
	ИначеЕсли ИмяОткрываемойФормы = "Обработка.Подключение1СТакском.Форма.ИзменениеТарифа" Тогда
		ПараметрыНовойФормы.Вставить("freePackagesED",
			Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "freePackagesED"));
		ПараметрыНовойФормы.Вставить("unallocatedPackagesED",
			Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "unallocatedPackagesED"));
		ПараметрыНовойФормы.Вставить("begindatetarifED",
			Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "begindatetarifED"));
		ПараметрыНовойФормы.Вставить("enddatetarifED",
			Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "enddatetarifED"));
		ПараметрыНовойФормы.Вставить("dateRequestED",
			Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "dateRequestED"));
		ПараметрыНовойФормы.Вставить("numberRequestED",
			Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "numberRequestED"));
...
Функция ПараметрыФормыОшибкиОбращения(КонтекстВзаимодействия)
	...
	Логин = Подключение1СТакскомКлиентСервер.ЗначениеСессионногоПараметра(КСКонтекст, "login");
