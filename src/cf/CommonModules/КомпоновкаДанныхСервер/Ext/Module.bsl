...
//					  - СхемаКомпоновкиДанных - собстенно схема компоновки данных
...
//					в полученной после использования компоновки таблице(дереве) значений они будут отсутсвовать,
//					если этот параметр передан, то фукнция дополнит полученную таблицу(дерево) значений недостающими
//					колонками
...
//                               	то результурующая таблица помещается по этому адресу
// 
// Возвращаемое значение:
...
//  СхемаКомпоновкиДанных - Строка,СхемаКомпоновкиДанных - адрес схемы компоновки временном хранилищи
//													или полное имя макета, например, Документ.РеализацияТоваровУслуг.ДанныеШаблонаСообщений
