...
Процедура ПриОпределенииНастроекРегламентныхЗаданий(Настройки) Экспорт
	...
	Настройка.ФункциональнаяОпция = Метаданные.ФункциональныеОпции.ИспользоватьОбменЭСФЧерезAPI;
	Настройка.РаботаетСВнешнимиРесурсами = Истина;
	
	Настройка = Настройки.Добавить();
	Настройка.РегламентноеЗадание = Метаданные.РегламентныеЗадания.ОбновлениеНоменклатурыГСВС;
	Настройка.ФункциональнаяОпция = Метаданные.ФункциональныеОпции.ИспользоватьОбменВС;
	
	ОтключитьРегламентноеЗадание(Настройки, "ВсеОбновленияСПАРКРискиОбщее");
	ОтключитьРегламентноеЗадание(Настройки, "ЗагрузкаКлассификатораБанков");
	ОтключитьРегламентноеЗадание(Настройки, "ВсеОбновленияСПАРКРискиРазделенное");
	...
	ОтключитьРегламентноеЗадание(Настройки, "ОбновлениеКлассификаторов");
	...
	ОтключитьРегламентноеЗадание(Настройки, "ОтправкаПолучениеДанныхГИСМ");
	...
	ОтключитьРегламентноеЗадание(Настройки, "ПроверкаГотовностиСправкиСПАРКРиски");
	ОтключитьРегламентноеЗадание(Настройки, "ПроверкаКонтрагентов");
	// в УПК отсутствует ОтражениеДокументовВУчетеСтраховыхВзносов
...
Процедура ОтключитьРегламентноеЗадание(Настройки, ИмяЗадания)
	...
	Если НайденнаяНастройка = Неопределено Тогда
		...
		Настройка.ФункциональнаяОпция = Метаданные.ФункциональныеОпции.ОтключенныйФункционал;
	ИначеЕсли НайденнаяНастройка.ФункциональнаяОпция <> Метаданные.ФункциональныеОпции.ОтключенныйФункционал Тогда
		НайденнаяНастройка.ФункциональнаяОпция = Метаданные.ФункциональныеОпции.ОтключенныйФункционал;
	КонецЕсли;
