...
Функция ПолучитьСтавкуНДС(СтавкаНДСККМ)
	...
	ИначеЕсли СтавкаНДСККМ = МенеджерОфлайнОборудования.ПолучитьСтавкуНДС12() Тогда
...
Функция ПолучитьСтавкуНДСККМ(СтавкаНДС)
	...
	ИначеЕсли СтавкаНДС = Справочники.СтавкиНДС.НДС12 Тогда
		
		Возврат МенеджерОфлайнОборудования.ПолучитьСтавкуНДС12();
