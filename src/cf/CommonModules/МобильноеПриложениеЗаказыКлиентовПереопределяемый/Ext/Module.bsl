...
Процедура ЗаполнитьШапкуДокумента(ДокументОбъект, МобильныеДанные, ТипДокумента)
	...
	Если НЕ ЗначениеЗаполнено(ДокументОбъект.НалогообложениеНДС) Тогда
		ДокументОбъект.НалогообложениеНДС = ЗначениеНастроекПовтИсп.НалогообложениеНДС(
			ДокументОбъект.Организация, ДокументОбъект.Склад,,, ДокументОбъект.Дата);
	КонецЕсли;
...
Процедура ЗаполнитьСправочникСоглашенияПриИзменении(СоглашениеОбъект)
	...
	СоглашениеОбъект.НалогообложениеНДС = ЗначениеНастроекПовтИсп.НалогообложениеНДС(
		СоглашениеОбъект.Организация,,,, ТекущаяДатаСеанса());
