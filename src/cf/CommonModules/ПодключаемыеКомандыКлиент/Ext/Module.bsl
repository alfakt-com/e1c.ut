...
Процедура ВыполнитьКоманду(Форма, Команда, Источник) Экспорт
	...
	Если ТипЗнч(Источник) = Тип("ДанныеФормыСтруктура") Тогда //++Аян_К++ 311022 №6306
		Контекст.Вставить("ТребуетсяПроведение", ?(ТипЗнч(Источник.Ссылка) = Тип("ДокументСсылка.СНТ"), Ложь, ОписаниеКоманды.РежимЗаписи = "Проводить")); 
	Иначе
