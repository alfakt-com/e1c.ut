...
Функция АналитикуРасходовПоУмолчанию(Организация, Подразделение, Знач СтатьяРасходов, Знач АналитикаРасходов) Экспорт
	
	ИнтеграцияСЯндексКассойУТ.АналитикуРасходовПоУмолчанию(Организация, Подразделение, СтатьяРасходов, АналитикаРасходов);
