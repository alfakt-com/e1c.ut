...
//                              скидок (наценок)
//  ИспользованиеСкидкиНаценки  - Структура - содержит информацию о использовании скидки (наценки). Подрбоно о полях
...
//  ИспользованиеСкидкиНаценки - Стркутура - содержит информацию о использовании скидки (наценки). Подрбоно о полях
//                                           структуры можно прочитать в описании функции ИспользованиеСкидкиНаценки.
