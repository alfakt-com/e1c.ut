...
Функция СтавкиПоОперациямОтражаемымВКнигеПродаж(ВходящиеПараметры) Экспорт
	...
	Если Параметры.ПрименяетсяОсвобождениеОтУплатыНДС Тогда
		МассивСтавок.Добавить(Справочники.СтавкиНДС.БезНДС);
	ИначеЕсли Параметры.ПлательщикНДС Тогда
		МассивСтавок.Добавить(Справочники.СтавкиНДС.НДС0);
		МассивСтавок.Добавить(Справочники.СтавкиНДС.НДС12);
...
Процедура ОбработкаПолученияДанныхВыбора(ДанныеВыбора, Параметры, СтандартнаяОбработка)
	...
	Если (ЗначениеЗаполнено(НалогообложениеНДС)
		...
		Или Параметры.Свойство("Номенклатура") Тогда
		
		МассивИсключаемыхЗначений.Добавить(Справочники.СтавкиНДС.НДС0);
